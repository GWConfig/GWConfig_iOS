...
@interface MKCFImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKCFImportServerController

- (void)dealloc {
    NSLog(@"MKCFImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(cf_selectedServerParams:)]) {
        [self.delegate cf_selectedServerParams:model.leftMsg];
    }
