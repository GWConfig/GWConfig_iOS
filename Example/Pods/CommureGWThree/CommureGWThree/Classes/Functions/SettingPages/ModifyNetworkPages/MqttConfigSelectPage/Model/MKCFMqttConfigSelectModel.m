...
@interface MKCFMqttConfigSelectModel ()
...
@implementation MKCFMqttConfigSelectModel
...
- (BOOL)downExcelData {
    NSString *excelPath = [self filePathWithName:@"MQTT MKGW3 Settings for Device.xlsx"];
