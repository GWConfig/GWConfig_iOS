//
//  MKCFConnectBeaconTimeoutController.m
...
@interface MKCFConnectBeaconTimeoutController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCFConnectBeaconTimeoutModel *dataModel;

@end

@implementation MKCFConnectBeaconTimeoutController

- (void)dealloc {
    NSLog(@"MKCFConnectBeaconTimeoutController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGWThree", @"MKCFConnectBeaconTimeoutController", @"cf_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCFConnectBeaconTimeoutModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCFConnectBeaconTimeoutModel alloc] init];
    }
    return _dataModel;
}
