...
@interface MKCFCommunicateController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCFCommunicateModel *dataModel;

@end

@implementation MKCFCommunicateController

- (void)dealloc {
    NSLog(@"MKCFCommunicateController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGWThree", @"MKCFCommunicateController", @"cf_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCFCommunicateModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCFCommunicateModel alloc] init];
    }
    return _dataModel;
}
