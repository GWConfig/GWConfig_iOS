...
@interface MKCFNetworkStatusController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCFNetworkStatusModel *dataModel;

@end

@implementation MKCFNetworkStatusController

- (void)dealloc {
    NSLog(@"MKCFNetworkStatusController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGWThree", @"MKCFNetworkStatusController", @"cf_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCFNetworkStatusModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCFNetworkStatusModel alloc] init];
    }
    return _dataModel;
}
