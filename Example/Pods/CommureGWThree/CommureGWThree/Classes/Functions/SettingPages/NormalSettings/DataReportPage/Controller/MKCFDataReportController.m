...
@interface MKCFDataReportController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCFDataReportModel *dataModel;

@end

@implementation MKCFDataReportController

- (void)dealloc {
    NSLog(@"MKCFDataReportController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGWThree", @"MKCFDataReportController", @"cf_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCFDataReportModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCFDataReportModel alloc] init];
    }
    return _dataModel;
}
