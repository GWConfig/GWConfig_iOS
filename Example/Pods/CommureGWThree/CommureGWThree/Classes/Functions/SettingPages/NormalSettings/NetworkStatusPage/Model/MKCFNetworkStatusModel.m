...
@interface MKCFNetworkStatusModel ()
...
@implementation MKCFNetworkStatusModel
...
- (BOOL)readReportInterval {
    ...
    [MKCFMQTTInterface cf_readNetworkStatusReportIntervalWithMacAddress:[MKCFDeviceModeManager shared].macAddress topic:[MKCFDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configReportInterval {
    __block BOOL success = NO;
    [MKCFMQTTInterface cf_configNetworkStatusReportInterval:[self.interval integerValue] macAddress:[MKCFDeviceModeManager shared].macAddress topic:[MKCFDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
