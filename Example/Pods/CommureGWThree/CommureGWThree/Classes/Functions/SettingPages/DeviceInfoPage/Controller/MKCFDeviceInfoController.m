...
@interface MKCFDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCFDeviceInfoModel *dataModel;

@end

@implementation MKCFDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCFDeviceInfoController销毁");
}
...
- (MKCFDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCFDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
