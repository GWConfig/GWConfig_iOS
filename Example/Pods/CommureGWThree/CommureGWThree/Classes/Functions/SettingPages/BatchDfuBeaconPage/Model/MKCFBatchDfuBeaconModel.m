...
@interface MKCFBatchDfuBeaconModel ()
...
@implementation MKCFBatchDfuBeaconModel
...
- (BOOL)configDatas:(NSArray <NSString *>*)list {
    ...
    [MKCFMQTTInterface cf_batchDfuBeacon:self.firmwareUrl dataFileUrl:self.dataUrl beaconList:dfuList macAddress:[MKCFDeviceModeManager shared].macAddress topic:[MKCFDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
