...
@interface MKCFOTAController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCFOTAPageModel *dataModel;

@end

@implementation MKCFOTAController

- (void)dealloc {
    NSLog(@"MKCFOTAController销毁");
...
- (MKCFOTAPageModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCFOTAPageModel alloc] init];
    }
    return _dataModel;
}
