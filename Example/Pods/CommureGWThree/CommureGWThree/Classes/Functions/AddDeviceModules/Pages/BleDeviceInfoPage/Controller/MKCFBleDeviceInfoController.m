...
@interface MKCFBleDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCFBleDeviceInfoModel *dataModel;

@end

@implementation MKCFBleDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCFBleDeviceInfoController销毁");
...
- (MKCFBleDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCFBleDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
