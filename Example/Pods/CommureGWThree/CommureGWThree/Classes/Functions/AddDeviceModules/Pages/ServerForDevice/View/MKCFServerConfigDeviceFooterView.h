//
//  MKCFServerConfigDeviceFooterView.h
...
@interface MKCFServerConfigDeviceFooterViewModel : NSObject
...
@protocol MKCFServerConfigDeviceFooterViewDelegate <NSObject>
...
@interface MKCFServerConfigDeviceFooterView : UIView

@property (nonatomic, strong)MKCFServerConfigDeviceFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKCFServerConfigDeviceFooterViewDelegate>delegate;
