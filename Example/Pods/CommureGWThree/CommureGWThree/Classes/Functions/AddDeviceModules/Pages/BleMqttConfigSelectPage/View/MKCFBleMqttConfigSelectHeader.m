//
//  MKCFBleMqttConfigSelectHeader.m
...
@interface MKCFBleMqttConfigSelectHeaderButton : UIControl
...
@implementation MKCFBleMqttConfigSelectHeaderButton
...
@interface MKCFBleMqttConfigSelectHeader ()

@property (nonatomic, strong)MKCFBleMqttConfigSelectHeaderButton *cloudButton;

@property (nonatomic, strong)MKCFBleMqttConfigSelectHeaderButton *manualButton;
...
@implementation MKCFBleMqttConfigSelectHeader
...
- (void)updateUI {
    ...
    if (self.selectedIndex == 0) {
        self.cloudButton.icon.image = LOADICON(@"CommureGWThree", @"MKCFBleMqttConfigSelectHeader", @"cf_resetByButtonSelectedIcon.png");
        self.manualButton.icon.image = LOADICON(@"CommureGWThree", @"MKCFBleMqttConfigSelectHeader", @"cf_resetByButtonUnselectedIcon.png");
        return;
    }
    self.cloudButton.icon.image = LOADICON(@"CommureGWThree", @"MKCFBleMqttConfigSelectHeader", @"cf_resetByButtonUnselectedIcon.png");
    self.manualButton.icon.image = LOADICON(@"CommureGWThree", @"MKCFBleMqttConfigSelectHeader", @"cf_resetByButtonSelectedIcon.png");
}

#pragma mark - getter
- (MKCFBleMqttConfigSelectHeaderButton *)cloudButton {
    if (!_cloudButton) {
        _cloudButton = [[MKCFBleMqttConfigSelectHeaderButton alloc] init];
        _cloudButton.icon.image = LOADICON(@"CommureGWThree", @"MKCFBleMqttConfigSelectHeader", @"cf_resetByButtonSelectedIcon.png");
...
- (MKCFBleMqttConfigSelectHeaderButton *)manualButton {
    if (!_manualButton) {
        _manualButton = [[MKCFBleMqttConfigSelectHeaderButton alloc] init];
        _manualButton.icon.image = LOADICON(@"CommureGWThree", @"MKCFBleMqttConfigSelectHeader", @"cf_resetByButtonUnselectedIcon.png");
