//
//  MKCFConfiguredGatewayHeaderView.m
...
@interface MKCFConfiguredGatewayHeaderView ()
...
@implementation MKCFConfiguredGatewayHeaderView
...
- (UIButton *)excelButton {
    if (!_excelButton) {
        ...
        [_excelButton setImage:LOADICON(@"CommureGWThree", @"MKCFConfiguredGatewayHeaderView", @"cf_batchOtaListSelectIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)scanButton {
    if (!_scanButton) {
        ...
        [_scanButton setImage:LOADICON(@"CommureGWThree", @"MKCFConfiguredGatewayHeaderView", @"cf_batchOtaQRCodeIcon.png") forState:UIControlStateNormal];
