...
@implementation MKCFConfiguredGatewayCellModel
@end

@interface MKCFConfiguredGatewayCell ()
...
@implementation MKCFConfiguredGatewayCell

+ (MKCFConfiguredGatewayCell *)initCellWithTableView:(UITableView *)tableView {
    MKCFConfiguredGatewayCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCFConfiguredGatewayCellIdenty"];
    if (!cell) {
        cell = [[MKCFConfiguredGatewayCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCFConfiguredGatewayCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKCFConfiguredGatewayCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCFConfiguredGatewayCellModel.class]) {
        return;
    }
