//
//  MKCFConfiguredGatewayHeaderView.h
...
@protocol MKCFConfiguredGatewayHeaderViewDelegate <NSObject>
...
@interface MKCFConfiguredGatewayHeaderView : UIView

@property (nonatomic, weak)id <MKCFConfiguredGatewayHeaderViewDelegate>delegate;
