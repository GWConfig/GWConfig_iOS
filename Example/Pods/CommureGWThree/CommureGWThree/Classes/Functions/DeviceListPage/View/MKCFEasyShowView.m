...
@implementation MKCFEasyShowView
...
- (UIImageView *)refreshIcon {
    if (!_refreshIcon) {
        ...
        _refreshIcon.image = LOADICON(@"CommureGWThree", @"MKCFEasyShowView", @"cf_refreshIcon.png");
    }
    return _refreshIcon;
}
