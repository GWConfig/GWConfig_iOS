//
//  MKCFManageBleDevicesSearchButton.m
...
@implementation MKCFManageBleDevicesSearchButtonModel
@end

@interface MKCFManageBleDevicesSearchButton ()
...
@implementation MKCFManageBleDevicesSearchButton
...
- (void)clearButtonPressed{
    ...
    if ([self.delegate respondsToSelector:@selector(cf_scanSearchButtonClearMethod)]) {
        [self.delegate cf_scanSearchButtonClearMethod];
    }
}

- (void)searchButtonPressed{
    if ([self.delegate respondsToSelector:@selector(cf_scanSearchButtonMethod)]) {
        [self.delegate cf_scanSearchButtonMethod];
    }
}

#pragma mark - setting
- (void)setDataModel:(MKCFManageBleDevicesSearchButtonModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCFManageBleDevicesSearchButtonModel.class]) {
        return;
    }
...
- (UIImageView *)searchIcon{
    if (!_searchIcon) {
        ...
        _searchIcon.image = LOADICON(@"CommureGWThree", @"MKCFManageBleDevicesSearchButton", @"cf_searchGrayIcon.png");
    }
    return _searchIcon;
}
...
- (UIButton *)clearButton{
    if (!_clearButton) {
        ...
        [_clearButton setImage:LOADICON(@"CommureGWThree", @"MKCFManageBleDevicesSearchButton", @"cf_clearButtonIcon.png") forState:UIControlStateNormal];
