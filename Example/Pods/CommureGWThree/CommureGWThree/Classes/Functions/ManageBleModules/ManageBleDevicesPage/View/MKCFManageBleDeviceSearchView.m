//
//  MKCFManageBleDeviceSearchView.m
...
@interface MKCFManageBleDeviceSearchView ()<UIGestureRecognizerDelegate>
...
@implementation MKCFManageBleDeviceSearchView

- (void)dealloc{
    NSLog(@"MKCFManageBleDeviceSearchView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKCFManageBleDeviceSearchView *view = [[MKCFManageBleDeviceSearchView alloc] init];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"CommureGWThree", @"MKCFManageBleDeviceSearchView", @"cf_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"CommureGWThree", @"MKCFManageBleDeviceSearchView", @"cf_wifiGraySignalIcon.png");
    }
