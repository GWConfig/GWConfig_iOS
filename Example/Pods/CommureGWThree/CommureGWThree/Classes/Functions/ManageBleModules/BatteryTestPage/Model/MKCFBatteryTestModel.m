...
@interface MKCFBatteryTestModel ()
...
@implementation MKCFBatteryTestModel
...
- (BOOL)readBatteryParams {
    ...
    [MKCFMQTTInterface cf_readBatterySelfTestWithBleMacAddress:self.bleMac macAddress:[MKCFDeviceModeManager shared].macAddress topic:[MKCFDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (BOOL)configBatteryParams {
    __block BOOL success = NO;
    [MKCFMQTTInterface cf_configBatterySelfTestWithLedState:self.isOn voltageThreshold:[self.voltageThreshold integerValue] bleMacAddress:self.bleMac macAddress:[MKCFDeviceModeManager shared].macAddress topic:[MKCFDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (BOOL)readBatteryTestLedParams0 {
    __block BOOL success = NO;
    [MKCFMQTTInterface cf_readBatterySelfTestLedParamsWithMode:0 bleMacAddress:self.bleMac macAddress:[MKCFDeviceModeManager shared].macAddress topic:[MKCFDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        if ([returnData[@"data"][@"result_code"] integerValue] == 0) {
            //成功
            success = YES;
...
- (BOOL)configBatteryTestLedParams0 {
    __block BOOL success = NO;
    [MKCFMQTTInterface cf_configBatterySelfTestLedParams:0 ledColor:self.color interval:[self.underInterval integerValue] duration:[self.underDuration integerValue] bleMacAddress:self.bleMac macAddress:[MKCFDeviceModeManager shared].macAddress topic:[MKCFDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = [returnData[@"data"][@"result_code"] integerValue] == 0;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBatteryTestLedParams1 {
    __block BOOL success = NO;
    [MKCFMQTTInterface cf_readBatterySelfTestLedParamsWithMode:1 bleMacAddress:self.bleMac macAddress:[MKCFDeviceModeManager shared].macAddress topic:[MKCFDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        if ([returnData[@"data"][@"result_code"] integerValue] == 0) {
            //成功
            success = YES;
...
- (BOOL)configBatteryTestLedParams1 {
    __block BOOL success = NO;
    [MKCFMQTTInterface cf_configBatterySelfTestLedParams:1 ledColor:self.color interval:[self.overInterval integerValue] duration:[self.overDuration integerValue] bleMacAddress:self.bleMac macAddress:[MKCFDeviceModeManager shared].macAddress topic:[MKCFDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = [returnData[@"data"][@"result_code"] integerValue] == 0;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
