...
@interface MKCFBeaconOTAPageModel ()
...
@implementation MKCFBeaconOTAPageModel
...
- (BOOL)startOTA {
    ...
    [MKCFMQTTInterface cf_batchDfuBeacon:self.firmwareUrl dataFileUrl:self.dataUrl beaconList:@[@{
