...
@interface MKCFFilterByTagController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCFFilterByTagModel *dataModel;

@end

@implementation MKCFFilterByTagController

- (void)dealloc {
    NSLog(@"MKCFFilterByTagController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGWThree", @"MKCFFilterByTagController", @"cf_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCFFilterByTagModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCFFilterByTagModel alloc] init];
    }
    return _dataModel;
}
