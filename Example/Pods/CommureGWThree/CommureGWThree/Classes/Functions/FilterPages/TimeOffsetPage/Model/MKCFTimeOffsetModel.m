...
@implementation MKCFTimeOffsetModel
...
- (BOOL)readTimeOffset {
    ...
    [MKCFMQTTInterface cf_readBXBDecryptTimeOffsetWithMacAddress:[MKCFDeviceModeManager shared].macAddress topic:[MKCFDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configTimeOffset {
    __block BOOL success = NO;
    [MKCFMQTTInterface cf_configBXBDecryptTimeOffset:[self.time integerValue] macAddress:[MKCFDeviceModeManager shared].macAddress topic:[MKCFDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
