...
@interface MKCFTimeOffsetController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCFTimeOffsetModel *dataModel;

@end

@implementation MKCFTimeOffsetController

- (void)dealloc {
    NSLog(@"MKCFTimeOffsetController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGWThree", @"MKCFTimeOffsetController", @"cf_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCFTimeOffsetModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCFTimeOffsetModel alloc] init];
    }
    return _dataModel;
}
