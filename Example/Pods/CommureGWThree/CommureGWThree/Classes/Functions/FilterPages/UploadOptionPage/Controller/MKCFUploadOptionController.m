...
@interface MKCFUploadOptionController ()<UITableViewDelegate,
UITableViewDataSource,
MKNormalSliderCellDelegate,
MKCFFilterCellDelegate>
...
@property (nonatomic, strong)MKCFUploadOptionModel *dataModel;

@end

@implementation MKCFUploadOptionController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 2) {
        MKCFFilterCell *cell = [MKCFFilterCell initCellWithTableView:tableView];
...
- (void)filterByMACAddress {
    MKCFFilterByMacController *vc = [[MKCFFilterByMacController alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)filterByTagID {
    MKCFFilterByTagController *vc = [[MKCFFilterByTagController alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)configTimeOffset {
    MKCFTimeOffsetController *vc = [[MKCFTimeOffsetController alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)configDecryptionKey {
    MKCFDecryptionKeyController *vc = [[MKCFDecryptionKeyController alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (void)loadSection2Datas {
    MKCFFilterCellModel *cellModel = [[MKCFFilterCellModel alloc] init];
    cellModel.index = 0;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGWThree", @"MKCFUploadOptionController", @"cf_saveIcon.png")
...
- (MKCFUploadOptionModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCFUploadOptionModel alloc] init];
    }
    return _dataModel;
}
