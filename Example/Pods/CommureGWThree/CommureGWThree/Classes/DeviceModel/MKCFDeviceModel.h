...
typedef NS_ENUM(NSInteger, MKCFDeviceModelState) {
    MKCFDeviceModelStateOffline,
    MKCFDeviceModelStateOnline,
};

//当设备离线的时候发出通知
extern NSString *const MKCFDeviceModelOfflineNotification;

@protocol MKCFDeviceModelDelegate <NSObject>
...
@interface MKCFDeviceModel : NSObject<MKCFDeviceModeManagerDataProtocol>
...
/**
 设备的状态，离线、在线
 */
@property (nonatomic, assign)MKCFDeviceModelState onLineState;

#pragma mark - 业务流程相关

@property (nonatomic, weak)id <MKCFDeviceModelDelegate>delegate;
