...
extern NSString *const mk_cf_peripheralConnectStateChangedNotification;

//Notification of changes in the status of the Bluetooth Center.
extern NSString *const mk_cf_centralManagerStateChangedNotification;
 ...
 */
extern NSString *const mk_cf_deviceDisconnectTypeNotification;

@class CBCentralManager,CBPeripheral;
@class MKCFOperation;

@interface MKCFCentralManager : NSObject<MKBLEBaseCentralManagerProtocol>

@property (nonatomic, weak)id <mk_cf_centralManagerScanDelegate>delegate;

/// Current connection status
@property (nonatomic, assign, readonly)mk_cf_centralConnectStatus connectStatus;
