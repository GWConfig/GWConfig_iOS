...
static NSString *const fileName = @"MKCFServerParams.txt";

@interface MKCFServerParamsModel ()
...
@implementation MKCFServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKCFServerParamsProtocol>)protocol {
