...
@implementation MKCHAlertViewModel
@end

@interface MKCHAlertView ()
...
@implementation MKCHAlertView

- (void)dealloc {
    NSLog(@"MKCHAlertView销毁");
}
...
- (void)showWithModel:(MKCHAlertViewModel *)dataModel
         cancelAction:(void (^)(void))cancelBlock
        confirmAction:(void (^)(void))confirmBlock {
    if (!dataModel || ![dataModel isKindOfClass:MKCHAlertViewModel.class]) {
        return;
    }
