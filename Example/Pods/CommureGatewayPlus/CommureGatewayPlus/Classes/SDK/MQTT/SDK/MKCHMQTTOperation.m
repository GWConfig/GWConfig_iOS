...
/**
 线程ID
 */
@property (nonatomic, assign)mk_ch_serverOperationID operationID;
...
@implementation MKCHMQTTOperation
@synthesize executing = _executing;
@synthesize finished = _finished;

- (void)dealloc{
    NSLog(@"MKCHMQTTOperation销毁");
}

- (instancetype)initOperationWithID:(mk_ch_serverOperationID)operationID
...
#pragma mark - MKCHMQTTOperationProtocol
...
- (void)didReceiveMessage:(NSDictionary *)data onTopic:(NSString *)topic {
    ...
    [self dataParserReceivedData:[MKCHMQTTTaskAdopter parseDataWithJson:data topic:topic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_ch_serverOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_ch_defaultServerOperationID || operationID != self.operationID) {
        return;
    }
