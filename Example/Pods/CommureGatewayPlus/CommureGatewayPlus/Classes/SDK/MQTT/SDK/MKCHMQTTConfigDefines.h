...
typedef NS_ENUM(NSInteger, mk_ch_keyResetType) {
    mk_ch_keyResetType_powerOnOneMin,     //Press in 1 min after powered
    mk_ch_keyResetType_pressAnyTime,      //Press any time
};

typedef NS_ENUM(NSInteger, mk_ch_filterRelationship) {
    mk_ch_filterRelationship_null,
    mk_ch_filterRelationship_mac,
    mk_ch_filterRelationship_tagID,
    mk_ch_filterRelationship_macOrTagID,
    mk_ch_filterRelationship_macAndTagID
};

typedef NS_ENUM(NSInteger, mk_ch_filterByTLM) {
    mk_ch_filterByTLM_nonEncrypted,        //Non-encrypted type TLM
    mk_ch_filterByTLM_encrypted,           //Encryption type TLM
    mk_ch_filterByTLM_all,                //Filter all Eddystone_TLM data
};

typedef NS_ENUM(NSInteger, mk_ch_filterByOther) {
    mk_ch_filterByOther_A,                 //Filter by A condition.
    mk_ch_filterByOther_AB,                //Filter by A & B condition.
    mk_ch_filterByOther_AOrB,              //Filter by A | B condition.
    mk_ch_filterByOther_ABC,               //Filter by A & B & C condition.
    mk_ch_filterByOther_ABOrC,             //Filter by (A & B) | C condition.
    mk_ch_filterByOther_AOrBOrC,           //Filter by A | B | C condition.
};

typedef NS_ENUM(NSInteger, mk_ch_duplicateDataFilter) {
    mk_ch_duplicateDataFilter_none,
    mk_ch_duplicateDataFilter_mac,
    mk_ch_duplicateDataFilter_macAndDataType,
    mk_ch_duplicateDataFilter_macAndRawData
};

typedef NS_ENUM(NSInteger, mk_ch_reminderLedColor) {
    mk_ch_reminderLedColor_red,
    mk_ch_reminderLedColor_blue,
    mk_ch_reminderLedColor_green,
};

typedef NS_ENUM(NSInteger, mk_ch_sosTriggerType) {
    mk_ch_sosTriggerType_singleClick,
    mk_ch_sosTriggerType_doubleClick,
    mk_ch_sosTriggerType_tripleClick,
};


typedef NS_ENUM(NSInteger, mk_ch_threeAxisSampleRate) {
    mk_ch_threeAxisSampleRate1hz,           //1hz
    mk_ch_threeAxisSampleRate10hz,          //10hz
    mk_ch_threeAxisSampleRate25hz,          //25hz
    mk_ch_threeAxisSampleRate50hz,          //50hz
    mk_ch_threeAxisSampleRate100hz          //100hz
};

typedef NS_ENUM(NSInteger, mk_ch_threeAxisDataFullScale) {
    mk_ch_threeAxisDataFullScale0,               //±2g
    mk_ch_threeAxisDataFullScale1,               //±4g
    mk_ch_threeAxisDataFullScale2,               //±8g
    mk_ch_threeAxisDataFullScale3                //±16g
};

typedef NS_ENUM(NSInteger, mk_ch_advParamsType) {
    mk_ch_advParamsType_config,               //Config advertisement
    mk_ch_advParamsType_noraml,               //Normal advertisement
    mk_ch_advParamsType_trigger,              //Trigger advertisement
};

typedef NS_ENUM(NSInteger, mk_ch_txPower) {
    mk_ch_txPowerNeg40dBm,   //RadioTxPower:-40dBm
    mk_ch_txPowerNeg20dBm,   //-20dBm
    mk_ch_txPowerNeg16dBm,   //-16dBm
    mk_ch_txPowerNeg12dBm,   //-12dBm
    mk_ch_txPowerNeg8dBm,    //-8dBm
    mk_ch_txPowerNeg4dBm,    //-4dBm
    mk_ch_txPower0dBm,       //0dBm
    mk_ch_txPower3dBm,       //3dBm
    mk_ch_txPower4dBm,       //4dBm
};


@protocol ch_indicatorLightStatusProtocol <NSObject>
...
@protocol mk_ch_BLEFilterRawDataProtocol <NSObject>
...
@protocol mk_ch_BLEFilterBXPButtonProtocol <NSObject>
...
@protocol mk_ch_BLEFilterPirProtocol <NSObject>
...
@protocol mk_ch_mqttModifyWifiProtocol <NSObject>
...
@protocol mk_ch_mqttModifyWifiEapCertProtocol <NSObject>
...
@protocol mk_ch_mqttModifyNetworkProtocol <NSObject>
...
@protocol mk_ch_modifyMqttServerProtocol <NSObject>
...
@protocol mk_ch_modifyMqttServerCertsProtocol <NSObject>
...
@protocol ch_uploadDataOptionProtocol <NSObject>
