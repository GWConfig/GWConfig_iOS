...
static NSString *const fileName = @"MKCHServerParams.txt";

@interface MKCHServerParamsModel ()
...
@implementation MKCHServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKCHServerParamsProtocol>)protocol {
