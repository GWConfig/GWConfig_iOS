...
@interface MKCHPeripheral ()

@property (nonatomic, strong)CBPeripheral *peripheral;

@end

@implementation MKCHPeripheral
...
- (void)updateCharacterWithService:(CBService *)service {
    [self.peripheral ch_updateCharacterWithService:service];
}

- (void)updateCurrentNotifySuccess:(CBCharacteristic *)characteristic {
    [self.peripheral ch_updateCurrentNotifySuccess:characteristic];
}

- (BOOL)connectSuccess {
    return [self.peripheral ch_connectSuccess];
}

- (void)setNil {
    [self.peripheral ch_setNil];
}
