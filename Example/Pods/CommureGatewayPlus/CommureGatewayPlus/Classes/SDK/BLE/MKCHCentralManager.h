...
extern NSString *const mk_ch_peripheralConnectStateChangedNotification;

//Notification of changes in the status of the Bluetooth Center.
extern NSString *const mk_ch_centralManagerStateChangedNotification;
 ...
 */
extern NSString *const mk_ch_deviceDisconnectTypeNotification;

@class CBCentralManager,CBPeripheral;
@class MKCHOperation;

@interface MKCHCentralManager : NSObject<MKBLEBaseCentralManagerProtocol>

@property (nonatomic, weak)id <mk_ch_centralManagerScanDelegate>delegate;

/// Current connection status
@property (nonatomic, assign, readonly)mk_ch_centralConnectStatus connectStatus;
