...
@interface MKCHBatchModifyTableHeader ()
...
@implementation MKCHBatchModifyTableHeader
...
- (MKTextField *)subTextField {
    if (!_subTextField) {
        _subTextField = [MKCustomUIAdopter customNormalTextFieldWithText:SafeStr([MKCHBatchModifyManager shared].params[@"subscribeTopic"])
...
- (MKTextField *)pubTextField {
    if (!_pubTextField) {
        _pubTextField = [MKCustomUIAdopter customNormalTextFieldWithText:SafeStr([MKCHBatchModifyManager shared].params[@"publishTopic"])
                                                               placeHolder:@"1- 128 Characters"
                                                                  textType:mk_normal];
...
- (UIButton *)excelButton {
    if (!_excelButton) {
        ...
        [_excelButton setImage:LOADICON(@"CommureGatewayPlus", @"MKCHBatchModifyTableHeader", @"ch_batchOtaListSelectIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)scanButton {
    if (!_scanButton) {
        ...
        [_scanButton setImage:LOADICON(@"CommureGatewayPlus", @"MKCHBatchModifyTableHeader", @"ch_batchOtaQRCodeIcon.png") forState:UIControlStateNormal];
