//
//  MKCHConfiguredGatewayHeaderView.m
...
@interface MKCHConfiguredGatewayHeaderView ()
...
@implementation MKCHConfiguredGatewayHeaderView
...
- (void)updateSubTopic:(NSString *)subTopic pubTopic:(NSString *)pubTopic {
    self.subTextField.text = subTopic;
    self.pubTextField.text = pubTopic;
}
...
- (UIButton *)excelButton {
    if (!_excelButton) {
        ...
        [_excelButton setImage:LOADICON(@"CommureGatewayPlus", @"MKCHConfiguredGatewayHeaderView", @"ch_batchOtaListSelectIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)scanButton {
    if (!_scanButton) {
        ...
        [_scanButton setImage:LOADICON(@"CommureGatewayPlus", @"MKCHConfiguredGatewayHeaderView", @"ch_batchOtaQRCodeIcon.png") forState:UIControlStateNormal];
