...
@implementation MKCHConfiguredGatewayCellModel
@end

@interface MKCHConfiguredGatewayCell ()
...
@implementation MKCHConfiguredGatewayCell

+ (MKCHConfiguredGatewayCell *)initCellWithTableView:(UITableView *)tableView {
    MKCHConfiguredGatewayCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCHConfiguredGatewayCellIdenty"];
    if (!cell) {
        cell = [[MKCHConfiguredGatewayCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCHConfiguredGatewayCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKCHConfiguredGatewayCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCHConfiguredGatewayCellModel.class]) {
        return;
    }
