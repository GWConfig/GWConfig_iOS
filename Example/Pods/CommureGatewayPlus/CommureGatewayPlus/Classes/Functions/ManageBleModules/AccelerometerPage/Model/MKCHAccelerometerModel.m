...
@interface MKCHAccelerometerModel ()
...
@implementation MKCHAccelerometerModel
...
- (BOOL)readAccelerometerParams {
    ...
    [MKCHMQTTInterface ch_readAccelerometerParamsWithBleMacAddress:self.bleMac macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (BOOL)configAccelerometerParams {
    __block BOOL success = NO;
    [MKCHMQTTInterface ch_configAccelerometerParamsWithBleMacAddress:self.bleMac sampleRate:self.sampleRate fullScale:self.fullScale sensitivity:[self.sensitivity integerValue] macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
