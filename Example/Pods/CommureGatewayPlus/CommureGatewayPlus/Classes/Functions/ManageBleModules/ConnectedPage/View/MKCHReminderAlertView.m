...
@implementation MKCHReminderAlertViewModel
@end

@interface MKCHReminderColorButton : UIControl
...
@implementation MKCHReminderColorButton
...
- (UIImageView *)icon {
    if (!_icon) {
        ...
        _icon.image = LOADICON(@"CommureGatewayPlus", @"MKCHReminderColorButton", @"ch_resetByButtonUnselectedIcon.png");
    }
    return _icon;
}
...
@interface MKCHReminderAlertView ()
...
@property (nonatomic, strong)MKCHReminderColorButton *redColor;

@property (nonatomic, strong)MKCHReminderColorButton *blueColor;

@property (nonatomic, strong)MKCHReminderColorButton *greenColor;

@end

@implementation MKCHReminderAlertView
...
- (void)setupColorIcons {
    self.redColor.icon.image = (self.currentColor == 0 ? LOADICON(@"CommureGatewayPlus", @"MKCHReminderColorButton", @"ch_resetByButtonSelectedIcon.png") : LOADICON(@"CommureGatewayPlus", @"MKCHReminderColorButton", @"ch_resetByButtonUnselectedIcon.png"));
    self.blueColor.icon.image = (self.currentColor == 1 ? LOADICON(@"CommureGatewayPlus", @"MKCHReminderColorButton", @"ch_resetByButtonSelectedIcon.png") : LOADICON(@"CommureGatewayPlus", @"MKCHReminderColorButton", @"ch_resetByButtonUnselectedIcon.png"));
    self.greenColor.icon.image = (self.currentColor == 2 ? LOADICON(@"CommureGatewayPlus", @"MKCHReminderColorButton", @"ch_resetByButtonSelectedIcon.png") : LOADICON(@"CommureGatewayPlus", @"MKCHReminderColorButton", @"ch_resetByButtonUnselectedIcon.png"));
}
...
- (MKCHReminderColorButton *)redColor {
    if (!_redColor) {
        _redColor = [[MKCHReminderColorButton alloc] init];
...
- (MKCHReminderColorButton *)blueColor {
    if (!_blueColor) {
        _blueColor = [[MKCHReminderColorButton alloc] init];
...
- (MKCHReminderColorButton *)greenColor {
    if (!_greenColor) {
        _greenColor = [[MKCHReminderColorButton alloc] init];
...
- (MKTextField *)durationTextField {
    if (!_durationTextField) {
        ...
        _durationTextField.maxLength = 3;
        _durationTextField.placeholder = @"1-255";
...
- (UILabel *)durationUnitLabel {
    if (!_durationUnitLabel) {
        ...
        _durationUnitLabel.text = @"second";
    }
