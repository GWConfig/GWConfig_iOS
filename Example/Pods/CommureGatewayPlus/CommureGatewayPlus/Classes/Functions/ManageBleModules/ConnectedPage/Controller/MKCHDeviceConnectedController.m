//
//  MKCHDeviceConnectedController.m
...
@interface MKCHDeviceConnectedController ()<UITableViewDelegate,
UITableViewDataSource,
mk_textSwitchCellDelegate,
MKCHDeviceConnectedButtonCellDelegate>
...
@property (nonatomic, strong)MKCHDeviceConnectedModel *dataModel;
...
@implementation MKCHDeviceConnectedController

- (void)dealloc {
    NSLog(@"MKCHDeviceConnectedController销毁");
...
- (void)leftButtonMethod {
    //用户点击左上角，则需要返回MKCHDeviceDataController
    [self popToViewControllerWithClassName:@"MKCHDeviceDataController"];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 5 && indexPath.row == 1) {
        ...
        MKCHSosTriggerController *vc = [[MKCHSosTriggerController alloc] init];
    ...
    if (indexPath.section == 5 && indexPath.row == 2) {
        ...
        MKCHSelfTestTriggerController *vc = [[MKCHSelfTestTriggerController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 5 && indexPath.row == 3) {
        ...
        MKCHBatteryTestController *vc = [[MKCHBatteryTestController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 6 && indexPath.row == 0) {
        ...
        MKCHAccelerometerController *vc = [[MKCHAccelerometerController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 6 && indexPath.row == 1) {
        ...
        MKCHSleepModeController *vc = [[MKCHSleepModeController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    ...
    if (indexPath.section == 7 && indexPath.row == 2) {
        //Button log
        MKCHButtonLogController *vc = [[MKCHButtonLogController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 7 && indexPath.row == 3) {
        ...
        MKCHSosAlarmNotiController *vc = [[MKCHSosAlarmNotiController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        vc.pageType = mk_ch_sosAlarmNotiPageType_normal;
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 7 && indexPath.row == 4) {
        ...
        MKCHSosAlarmNotiController *vc = [[MKCHSosAlarmNotiController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        vc.pageType = mk_ch_sosAlarmNotiPageType_dismiss;
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 7 && indexPath.row == 5) {
        //Button press effective interval
        MKCHButtonPressEffIntervalController *vc = [[MKCHButtonPressEffIntervalController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    ...
    if (indexPath.section == 8 && indexPath.row == 0) {
        //ADV parameters
        MKCHAdvParamsConfigController *vc = [[MKCHAdvParamsConfigController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 1) {
        MKCHDeviceConnectedButtonCell *cell = [MKCHDeviceConnectedButtonCell initCellWithTableView:tableView];
...
#pragma mark - MKCHDeviceConnectedButtonCellDelegate
- (void)ch_deviceConnectedButtonCell_buttonPressed:(NSInteger)index {
    if (index == 0) {
        //DFU
        MKCHBeaconOTAController *vc = [[MKCHBeaconOTAController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
...
- (void)receiveDisconnect:(NSNotification *)note {
    ...
    if (!ValidDict(user) || !ValidStr(user[@"device_info"][@"mac"]) || ![[MKCHDeviceModeManager shared].macAddress isEqualToString:user[@"device_info"][@"mac"]]) {
        return;
    }
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_ch_needDismissAlert" object:nil];
    //返回上一级页面
    [self gotoLastPage];
}
...
- (void)disconnect {
    ...
    [MKCHMQTTInterface ch_disconnectBleDeviceWithBleMac:self.deviceBleInfo[@"data"][@"mac"] macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
...
- (void)dismissAlarmStatus {
    [[MKHudManager share] showHUDWithTitle:@"Waiting..." inView:self.view isPenetration:NO];
    [MKCHMQTTInterface ch_dismissBXPButtonAlarmStatusWithBleMacAddress:self.deviceBleInfo[@"data"][@"mac"] macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
...
- (void)sendTagIDToDevice {
    ...
    [MKCHMQTTInterface ch_configTagID:self.targetTagId bleMac:self.deviceBleInfo[@"data"][@"mac"] macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
        if ([returnData[@"data"][@"result_code"] integerValue] != 0) {
...
- (void)sendLedReminder:(NSString *)interval duration:(NSString *)duration color:(NSInteger)color {
    ...
    [[MKHudManager share] showHUDWithTitle:@"Config..." inView:self.view isPenetration:NO];
    [MKCHMQTTInterface ch_configDeviceLedReminderWithBleMac:self.deviceBleInfo[@"data"][@"mac"] color:color interval:([interval integerValue] * 100) duration:[duration integerValue] macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
        if ([returnData[@"data"][@"result_code"] integerValue] != 0) {
            [self.view showCentralToast:@"setup failed!"];
            return;
...
- (void)sendBuzzerReminder:(NSString *)interval duration:(NSString *)duration {
    ...
    [[MKHudManager share] showHUDWithTitle:@"Config..." inView:self.view isPenetration:NO];
    [MKCHMQTTInterface ch_configDeviceBuzzerReminderWithBleMac:self.deviceBleInfo[@"data"][@"mac"] interval:([interval integerValue] * 100) duration:[duration integerValue] macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
        if ([returnData[@"data"][@"result_code"] integerValue] != 0) {
            [self.view showCentralToast:@"setup failed!"];
            return;
...
- (void)syncTimestamp {
    ...
    [MKCHMQTTInterface ch_configDeviceTimestampWithBleMac:self.deviceBleInfo[@"data"][@"mac"] timestamp:timestamp macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
        if ([returnData[@"data"][@"result_code"] integerValue] != 0) {
            [self.view showCentralToast:@"setup failed!"];
            return;
...
- (void)sendEncryptionKeyToDevice {
    ...
    [[MKHudManager share] showHUDWithTitle:@"Config..." inView:self.view isPenetration:NO];
    [MKCHMQTTInterface ch_batchUpdateKey:self.encryptionKey beaconList:@[@{
        @"macAddress":SafeStr(self.deviceBleInfo[@"data"][@"mac"]),
        @"password":@""
    }] macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
        if ([returnData[@"data"][@"result_code"] integerValue] != 0) {
            [self.view showCentralToast:@"setup failed!"];
            return;
...
- (void)sendPowerOffToDevice {
    [[MKHudManager share] showHUDWithTitle:@"Config..." inView:self.view isPenetration:NO];
    [MKCHMQTTInterface ch_powerOffConnectedDeviceWithBleMac:self.deviceBleInfo[@"data"][@"mac"] macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
        if ([returnData[@"data"][@"result_code"] integerValue] != 0) {
            [self.view showCentralToast:@"setup failed!"];
            return;
...
- (void)sendResetToDevice {
    [[MKHudManager share] showHUDWithTitle:@"Config..." inView:self.view isPenetration:NO];
    [MKCHMQTTInterface ch_resetConnectedDeviceWithBleMac:self.deviceBleInfo[@"data"][@"mac"] macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
        if ([returnData[@"data"][@"result_code"] integerValue] != 0) {
            [self.view showCentralToast:@"setup failed!"];
            return;
...
- (void)sendPasswordToDevice {
    [[MKHudManager share] showHUDWithTitle:@"Config..." inView:self.view isPenetration:NO];
    [MKCHMQTTInterface ch_configPasswordVerificationWithBleMacAddress:self.deviceBleInfo[@"data"][@"mac"] password:self.password macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
        if ([returnData[@"data"][@"result_code"] integerValue] != 0) {
            [self.view showCentralToast:@"setup failed!"];
            return;
...
- (void)sendPasswordVerificationToDevice:(BOOL)isOn {
    [[MKHudManager share] showHUDWithTitle:@"Config..." inView:self.view isPenetration:NO];
    [MKCHMQTTInterface ch_configPasswordVerificationStatusWithBleMacAddress:self.deviceBleInfo[@"data"][@"mac"] isOn:isOn macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
        if ([returnData[@"data"][@"result_code"] integerValue] != 0) {
            [self.view showCentralToast:@"setup failed!"];
            return;
...
- (void)updateCellState {
    ...
    MKCHDeviceConnectedButtonCellModel *batteryModel = self.section1List[1];
    batteryModel.valueMsg = [SafeStr(self.dataModel.battery) stringByAppendingString:@"mV"];
    
    MKCHDeviceConnectedButtonCellModel *alarmModel = self.section2List[0];
...
- (void)addNotes {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(receiveDisconnect:)
                                                 name:MKCHReceiveGatewayDisconnectDeviceNotification
                                               object:nil];
}
...
- (void)showTagIDAlert {
    ...
    [alertView showAlertWithTitle:@"Modify Tag ID" message:@"" notificationName:@"mk_ch_needDismissAlert"];
}

- (void)showLedReminderAlert {
    MKCHReminderAlertViewModel *dataModel = [[MKCHReminderAlertViewModel alloc] init];
    ...
    MKCHReminderAlertView *alertView = [[MKCHReminderAlertView alloc] init];
...
- (void)showEncryptionKeyAlert {
    ...
    [alertView addAction:confirmAction];
    [alertView addTextField:textField];
    [alertView showAlertWithTitle:@"Update encryption key" message:@"" notificationName:@"mk_ch_needDismissAlert"];
}
...
- (void)showPasswordAlert {
    ...
    [alertView addAction:confirmAction];
    [alertView addTextField:textField];
    [alertView showAlertWithTitle:@"Change password" message:@"" notificationName:@"mk_ch_needDismissAlert"];
}

- (void)gotoLastPage {
    //返回上一级页面
    for (UIViewController *vc in self.navigationController.viewControllers) {
        if ([vc isKindOfClass:NSClassFromString(@"MKCHManageBleDevicesController")]) {
            //如果是从Manage BLE devices页面进来的
            [self popToViewControllerWithClassName:@"MKCHManageBleDevicesController"];
            break;
        }
        if ([vc isKindOfClass:NSClassFromString(@"MKCHDeviceDataController")]) {
            //如果是从扫描页面进来的
            [self popToViewControllerWithClassName:@"MKCHDeviceDataController"];
            break;
        }
...
- (void)loadSection1Datas {
    MKCHDeviceConnectedButtonCellModel *cellModel1 = [[MKCHDeviceConnectedButtonCellModel alloc] init];
    cellModel1.index = 0;
    ...
    MKCHDeviceConnectedButtonCellModel *cellModel2 = [[MKCHDeviceConnectedButtonCellModel alloc] init];
    cellModel2.index = 1;
...
- (void)loadSection2Datas {
    MKCHDeviceConnectedButtonCellModel *cellModel = [[MKCHDeviceConnectedButtonCellModel alloc] init];
    cellModel.index = 2;
...
- (MKCHDeviceConnectedModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCHDeviceConnectedModel alloc] init];
