//
//  MKCHManageBleDeviceSearchView.m
...
@interface MKCHManageBleDeviceSearchView ()<UIGestureRecognizerDelegate>
...
@implementation MKCHManageBleDeviceSearchView

- (void)dealloc{
    NSLog(@"MKCHManageBleDeviceSearchView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKCHManageBleDeviceSearchView *view = [[MKCHManageBleDeviceSearchView alloc] init];
...
- (void)showSearchName:(NSString *)name
    ...
    [UIView animateWithDuration:0.25 animations:^{
        self.backView.transform = CGAffineTransformMakeTranslation(0, backViewHeight + kNavigationBarHeight + 44.f);
    } completion:^(BOOL finished) {
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"CommureGatewayPlus", @"MKCHManageBleDeviceSearchView", @"ch_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"CommureGatewayPlus", @"MKCHManageBleDeviceSearchView", @"ch_wifiGraySignalIcon.png");
    }
