//
//  MKCHManageBleDevicesSearchButton.m
...
@implementation MKCHManageBleDevicesSearchButtonModel
@end

@interface MKCHManageBleDevicesSearchButton ()
...
@implementation MKCHManageBleDevicesSearchButton
...
- (void)clearButtonPressed{
    ...
    if ([self.delegate respondsToSelector:@selector(ch_scanSearchButtonClearMethod)]) {
        [self.delegate ch_scanSearchButtonClearMethod];
    }
}

- (void)searchButtonPressed{
    if ([self.delegate respondsToSelector:@selector(ch_scanSearchButtonMethod)]) {
        [self.delegate ch_scanSearchButtonMethod];
    }
}

#pragma mark - setting
- (void)setDataModel:(MKCHManageBleDevicesSearchButtonModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCHManageBleDevicesSearchButtonModel.class]) {
        return;
    }
...
- (UIImageView *)searchIcon{
    if (!_searchIcon) {
        ...
        _searchIcon.image = LOADICON(@"CommureGatewayPlus", @"MKCHManageBleDevicesSearchButton", @"ch_searchGrayIcon.png");
    }
    return _searchIcon;
}
...
- (UIButton *)clearButton{
    if (!_clearButton) {
        ...
        [_clearButton setImage:LOADICON(@"CommureGatewayPlus", @"MKCHManageBleDevicesSearchButton", @"ch_clearButtonIcon.png") forState:UIControlStateNormal];
