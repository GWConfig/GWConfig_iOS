//
//  MKCHManageBleDevicesController.m
...
@interface MKCHManageBleDevicesController ()<UITableViewDelegate,
UITableViewDataSource,
MKCHManageBleDevicesSearchButtonDelegate,
MKCHManageBleDevicesCellDelegate>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)MKCHManageBleDevicesSearchButtonModel *buttonModel;

@property (nonatomic, strong)MKCHManageBleDevicesSearchButton *searchButton;
...
@implementation MKCHManageBleDevicesController

- (void)dealloc {
    NSLog(@"MKCHManageBleDevicesController销毁");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MKCHManageBleDevicesCell *cell = [MKCHManageBleDevicesCell initCellWithTableView:tableView];
    cell.dataModel = self.dataList[indexPath.row];
    cell.delegate = self;
    return cell;
}

#pragma mark - MKCHManageBleDevicesSearchButtonDelegate
- (void)ch_scanSearchButtonMethod {
    [MKCHManageBleDeviceSearchView showSearchName:self.buttonModel.searchName
...
- (void)ch_scanSearchButtonClearMethod {
...
#pragma mark - MKCHManageBleDevicesCellDelegate
/// 用户点击了链接按钮
...
- (void)ch_manageBleDevicesCellConnectButtonPressed:(NSString *)macAddress typeCode:(NSInteger)typeCode; {
    ...
    [alertView showAlertWithTitle:@"Enter password" message:@"" notificationName:@"mk_ch_needDismissAlert"];
}
...
- (void)addNotes {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(receiveDeviceDatas:)
                                                 name:MKCHReceiveDeviceDatasNotification
                                               object:nil];
}
...
- (void)updateCellModelWithMac:(NSString *)macAddress
    ...
    MKCHManageBleDevicesCellModel *cellModel = [[MKCHManageBleDevicesCellModel alloc] init];
...
- (void)connectBeaconWithPassword:(NSString *)password bleMac:(NSString *)bleMac {
    ...
    [MKCHMQTTInterface ch_connectBXPButtonWithPassword:password bleMac:bleMac macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (MKCHManageBleDevicesSearchButton *)searchButton {
    if (!_searchButton) {
        _searchButton = [[MKCHManageBleDevicesSearchButton alloc] init];
        _searchButton.delegate = self;
    }
    return _searchButton;
}

- (MKCHManageBleDevicesSearchButtonModel *)buttonModel {
    if (!_buttonModel) {
        _buttonModel = [[MKCHManageBleDevicesSearchButtonModel alloc] init];
