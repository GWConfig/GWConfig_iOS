...
@interface MKCHBeaconOTAPageModel ()
...
@implementation MKCHBeaconOTAPageModel
...
- (BOOL)startOTA {
    ...
    [MKCHMQTTInterface ch_batchDfuBeacon:self.firmwareUrl dataFileUrl:self.dataUrl beaconList:@[@{
        @"macAddress":SafeStr(self.bleMac),
        @"password":@"",
