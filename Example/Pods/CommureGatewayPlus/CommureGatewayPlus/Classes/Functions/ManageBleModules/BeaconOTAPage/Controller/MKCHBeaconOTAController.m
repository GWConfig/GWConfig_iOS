...
@interface MKCHBeaconOTAController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCHBeaconOTAPageModel *dataModel;
...
@implementation MKCHBeaconOTAController

- (void)dealloc {
    NSLog(@"MKCHBeaconOTAController销毁");
...
- (void)addNotes {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(receiveDfuProgress:)
                                                 name:MKCHReceiveBxpButtonDfuProgressNotification
                                               object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(receiveDisconnect:)
                                                 name:MKCHReceiveGatewayDisconnectBXPButtonNotification
                                               object:nil];
}
...
- (MKCHBeaconOTAPageModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCHBeaconOTAPageModel alloc] init];
