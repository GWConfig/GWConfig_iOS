...
@interface MKCHDecryptionKeyController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCHDecryptionKeyModel *dataModel;

@end

@implementation MKCHDecryptionKeyController

- (void)dealloc {
    NSLog(@"MKCHDecryptionKeyController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGatewayPlus", @"MKCHDecryptionKeyController", @"ch_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCHDecryptionKeyModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCHDecryptionKeyModel alloc] init];
    }
    return _dataModel;
}
