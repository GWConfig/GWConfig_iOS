...
@interface MKCHUploadOptionController ()<UITableViewDelegate,
UITableViewDataSource,
MKNormalSliderCellDelegate,
MKCHFilterCellDelegate>
...
@property (nonatomic, strong)MKCHUploadOptionModel *dataModel;

@end

@implementation MKCHUploadOptionController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 2) {
        MKCHFilterCell *cell = [MKCHFilterCell initCellWithTableView:tableView];
...
- (void)filterByMACAddress {
    MKCHFilterByMacController *vc = [[MKCHFilterByMacController alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)filterByTagID {
    MKCHFilterByTagController *vc = [[MKCHFilterByTagController alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)configTimeOffset {
    MKCHTimeOffsetController *vc = [[MKCHTimeOffsetController alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)configDecryptionKey {
    MKCHDecryptionKeyController *vc = [[MKCHDecryptionKeyController alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (void)loadSection2Datas {
    MKCHFilterCellModel *cellModel = [[MKCHFilterCellModel alloc] init];
    cellModel.index = 0;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGatewayPlus", @"MKCHUploadOptionController", @"ch_saveIcon.png")
...
- (MKCHUploadOptionModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCHUploadOptionModel alloc] init];
    }
    return _dataModel;
}
