...
@interface MKCHTimeOffsetController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCHTimeOffsetModel *dataModel;

@end

@implementation MKCHTimeOffsetController

- (void)dealloc {
    NSLog(@"MKCHTimeOffsetController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGatewayPlus", @"MKCHTimeOffsetController", @"ch_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCHTimeOffsetModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCHTimeOffsetModel alloc] init];
    }
    return _dataModel;
}
