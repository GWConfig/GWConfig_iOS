...
@interface MKCHBleNTPTimezoneModel ()
...
@implementation MKCHBleNTPTimezoneModel
...
- (BOOL)readNTPHost {
    ...
    [MKCHInterface ch_readNTPServerHostWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readTimezone {
    __block BOOL success = NO;
    [MKCHInterface ch_readTimeZoneWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
