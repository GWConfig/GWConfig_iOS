//
//  MKCHConnectSuccessController.m
...
@interface MKCHConnectSuccessController ()
...
@implementation MKCHConnectSuccessController

- (void)dealloc {
    NSLog(@"MKCHConnectSuccessController销毁");
}
...
- (void)saveButtonPressed {
    ...
    [MKCHDeviceDatabaseManager insertDeviceList:@[self.deviceModel] sucBlock:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_ch_addNewDeviceSuccessNotification"
                                                            object:nil
