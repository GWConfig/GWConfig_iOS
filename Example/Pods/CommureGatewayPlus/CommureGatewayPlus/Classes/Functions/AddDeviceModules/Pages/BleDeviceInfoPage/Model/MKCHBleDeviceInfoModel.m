...
@interface MKCHBleDeviceInfoModel ()
...
@implementation MKCHBleDeviceInfoModel
...
- (void)readDataWithSucBlock:(void (^)(void))sucBlock failedBlock:(void (^)(NSError *error))failedBlock {
    dispatch_async(self.readQueue, ^{
        ...
        if (![self readBleFirmware]) {
            [self operationFailedBlockWithMsg:@"Read Ble firmware error" block:failedBlock];
            return ;
        }
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKCHInterface ch_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKCHInterface ch_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKCHInterface ch_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKCHInterface ch_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKCHInterface ch_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readMacAddress {
    __block BOOL success = NO;
    [MKCHInterface ch_readMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readBleFirmware {
    __block BOOL success = NO;
    [MKCHInterface ch_readBleFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
