...
@interface MKCHServerForDeviceModel ()
...
@implementation MKCHServerForDeviceModel
...
- (void)updateValue:(MKCHServerForDeviceModel *)model {
    if (!model || ![model isKindOfClass:MKCHServerForDeviceModel.class]) {
        return;
    }
...
- (void)readDataWithSucBlock:(void (^)(void))sucBlock failedBlock:(void (^)(NSError *error))failedBlock {
    dispatch_async(self.configQueue, ^{
        ...
        if ([MKCHDeviceMQTTParamsModel shared].cloud) {
            //从云端导入
            MKCHServerForDeviceModel *model = [MKCHServerForDeviceModel mk_modelWithJSON:[MKCHDeviceMQTTParamsModel shared].params];
...
- (BOOL)readHost {
    __block BOOL success = NO;
    [MKCHInterface ch_readServerHostWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readPort {
    __block BOOL success = NO;
    [MKCHInterface ch_readServerPortWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readUsername {
    __block BOOL success = NO;
    [MKCHInterface ch_readServerUserNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readPassword {
    __block BOOL success = NO;
    [MKCHInterface ch_readServerPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readCleanSession {
    __block BOOL success = NO;
    [MKCHInterface ch_readServerCleanSessionWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readKeepAlive {
    __block BOOL success = NO;
    [MKCHInterface ch_readServerKeepAliveWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readQos {
    __block BOOL success = NO;
    [MKCHInterface ch_readServerQosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSubscribe {
    __block BOOL success = NO;
    [MKCHInterface ch_readSubscibeTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSubscribe {
    ...
    [MKCHInterface ch_configSubscibeTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)readPublish {
    __block BOOL success = NO;
    [MKCHInterface ch_readPublishTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPublish {
    ...
    [MKCHInterface ch_configPublishTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)readSSLStatus {
    __block BOOL success = NO;
    [MKCHInterface ch_readConnectModeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
