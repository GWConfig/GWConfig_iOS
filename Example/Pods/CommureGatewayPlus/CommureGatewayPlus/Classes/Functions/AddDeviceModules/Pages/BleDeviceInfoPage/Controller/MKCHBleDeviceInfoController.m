...
@interface MKCHBleDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCHBleDeviceInfoModel *dataModel;

@end

@implementation MKCHBleDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCHBleDeviceInfoController销毁");
...
- (void)loadSectionDatas {
    ...
    cellModel6.leftMsg = @"BLE firmware vesrion";
    cellModel6.rightMsg = self.dataModel.bleFirmware;
...
- (MKCHBleDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCHBleDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
