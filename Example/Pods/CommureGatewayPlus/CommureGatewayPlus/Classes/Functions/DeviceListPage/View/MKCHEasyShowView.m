...
@implementation MKCHEasyShowView
...
- (UIImageView *)refreshIcon {
    if (!_refreshIcon) {
        ...
        _refreshIcon.image = LOADICON(@"CommureGatewayPlus", @"MKCHEasyShowView", @"ch_refreshIcon.png");
    }
    return _refreshIcon;
}
