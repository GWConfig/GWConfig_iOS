...
@implementation MKCHAddDeviceView
...
- (UIImageView *)centerIcon{
    if (!_centerIcon) {
        ...
        _centerIcon.image = LOADICON(@"CommureGatewayPlus", @"MKCHAddDeviceView", @"ch_deviceList_centerIcon.png");
    }
    return _centerIcon;
}
