//
//  MKCHMqttNetworkSettingsController.m
...
@interface MKCHMqttNetworkSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCHMqttNetworkSettingsModel *dataModel;

@end

@implementation MKCHMqttNetworkSettingsController

- (void)dealloc {
    NSLog(@"MKCHMqttNetworkSettingsController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGatewayPlus", @"MKCHMqttNetworkSettingsController", @"ch_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCHMqttNetworkSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCHMqttNetworkSettingsModel alloc] init];
    }
    return _dataModel;
}
