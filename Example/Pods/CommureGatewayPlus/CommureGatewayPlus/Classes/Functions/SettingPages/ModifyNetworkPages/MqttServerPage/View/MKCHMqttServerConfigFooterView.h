//
//  MKCHMqttServerConfigFooterView.h
...
@interface MKCHMqttServerConfigFooterViewModel : NSObject
...
@protocol MKCHMqttServerConfigFooterViewDelegate <NSObject>
...
@interface MKCHMqttServerConfigFooterView : UIView

@property (nonatomic, strong)MKCHMqttServerConfigFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKCHMqttServerConfigFooterViewDelegate>delegate;
