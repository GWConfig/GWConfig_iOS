...
@interface MKCHBatchUpdateKeyModel ()
...
@implementation MKCHBatchUpdateKeyModel
...
- (BOOL)configDatas:(NSArray *)list {
    ...
    [MKCHMQTTInterface ch_batchUpdateKey:self.encryptionKey beaconList:dfuList macAddress:[MKCHDeviceModeManager shared].macAddress topic:[MKCHDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
