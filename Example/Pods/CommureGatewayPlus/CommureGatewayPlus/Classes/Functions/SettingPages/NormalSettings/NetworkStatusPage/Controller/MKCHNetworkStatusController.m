...
@interface MKCHNetworkStatusController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCHNetworkStatusModel *dataModel;

@end

@implementation MKCHNetworkStatusController

- (void)dealloc {
    NSLog(@"MKCHNetworkStatusController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGatewayPlus", @"MKCHNetworkStatusController", @"ch_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCHNetworkStatusModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCHNetworkStatusModel alloc] init];
    }
    return _dataModel;
}
