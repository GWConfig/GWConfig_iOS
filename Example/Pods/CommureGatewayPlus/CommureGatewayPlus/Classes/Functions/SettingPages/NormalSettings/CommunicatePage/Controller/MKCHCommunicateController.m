...
@interface MKCHCommunicateController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCHCommunicateModel *dataModel;

@end

@implementation MKCHCommunicateController

- (void)dealloc {
    NSLog(@"MKCHCommunicateController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGatewayPlus", @"MKCHCommunicateController", @"ch_saveIcon.png") forState:UIControlStateNormal];
...
- (MKTextField *)textField {
    if (!_textField) {
        ...
        _textField.placeholder = @"0-60，unit: second";
...
- (MKCHCommunicateModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCHCommunicateModel alloc] init];
    }
    return _dataModel;
}
