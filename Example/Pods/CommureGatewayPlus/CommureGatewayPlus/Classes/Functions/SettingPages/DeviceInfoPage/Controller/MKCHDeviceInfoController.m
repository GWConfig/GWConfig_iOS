...
@interface MKCHDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCHDeviceInfoModel *dataModel;

@end

@implementation MKCHDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCHDeviceInfoController销毁");
}
...
- (MKCHDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCHDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
