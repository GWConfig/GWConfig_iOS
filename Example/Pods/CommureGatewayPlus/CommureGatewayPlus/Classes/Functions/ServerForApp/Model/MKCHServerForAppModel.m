...
@implementation MKCHServerForAppModel
...
- (void)updateValue:(MKCHServerForAppModel *)model {
    if (!model || ![model isKindOfClass:MKCHServerForAppModel.class]) {
        return;
    }
...
- (void)loadServerParams {
    ...
    self.host = [MKCHMQTTDataManager shared].serverParams.host;
    self.port = [MKCHMQTTDataManager shared].serverParams.port;
    self.clientID = [MKCHMQTTDataManager shared].serverParams.clientID;
    self.cleanSession = [MKCHMQTTDataManager shared].serverParams.cleanSession;
    
    self.qos = [MKCHMQTTDataManager shared].serverParams.qos;
    self.keepAlive = [MKCHMQTTDataManager shared].serverParams.keepAlive;
    self.userName = [MKCHMQTTDataManager shared].serverParams.userName;
    self.password = [MKCHMQTTDataManager shared].serverParams.password;
    self.sslIsOn = [MKCHMQTTDataManager shared].serverParams.sslIsOn;
    self.certificate = [MKCHMQTTDataManager shared].serverParams.certificate;
    self.caFileName = [MKCHMQTTDataManager shared].serverParams.caFileName;
    self.clientFileName = [MKCHMQTTDataManager shared].serverParams.clientFileName;
}
