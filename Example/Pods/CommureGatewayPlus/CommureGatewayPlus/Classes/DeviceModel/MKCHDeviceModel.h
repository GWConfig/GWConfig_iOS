...
typedef NS_ENUM(NSInteger, MKCHDeviceModelState) {
    MKCHDeviceModelStateOffline,
    MKCHDeviceModelStateOnline,
};

//当设备离线的时候发出通知
extern NSString *const MKCHDeviceModelOfflineNotification;

@protocol MKCHDeviceModelDelegate <NSObject>
...
@interface MKCHDeviceModel : NSObject<MKCHDeviceModeManagerDataProtocol>
...
/**
 设备的状态，离线、在线
 */
@property (nonatomic, assign)MKCHDeviceModelState onLineState;

#pragma mark - 业务流程相关

@property (nonatomic, weak)id <MKCHDeviceModelDelegate>delegate;
