...
@interface MKCGQRCodeController () <SGScanCodeDelegate, SGScanCodeSampleBufferDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
{
    SGScanCode *scanCode;
}
...
- (MKCGQRToolBar *)toolBar {
    if (!_toolBar) {
        _toolBar = [(MKCGQRToolBar *)[MKCGQRToolBar alloc] init];
        CGFloat h = 220;
