//
//  MKCGManageBleDevicesSearchButton.m
...
@implementation MKCGManageBleDevicesSearchButtonModel
@end

@interface MKCGManageBleDevicesSearchButton ()
...
@implementation MKCGManageBleDevicesSearchButton
...
- (void)clearButtonPressed{
    ...
    if ([self.delegate respondsToSelector:@selector(cg_scanSearchButtonClearMethod)]) {
        [self.delegate cg_scanSearchButtonClearMethod];
    }
}

- (void)searchButtonPressed{
    if ([self.delegate respondsToSelector:@selector(cg_scanSearchButtonMethod)]) {
        [self.delegate cg_scanSearchButtonMethod];
    }
}

#pragma mark - setting
- (void)setDataModel:(MKCGManageBleDevicesSearchButtonModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCGManageBleDevicesSearchButtonModel.class]) {
        return;
    }
...
- (UIImageView *)searchIcon{
    if (!_searchIcon) {
        ...
        _searchIcon.image = LOADICON(@"CommureGateway", @"MKCGManageBleDevicesSearchButton", @"cg_searchGrayIcon.png");
    }
    return _searchIcon;
}
...
- (UIButton *)clearButton{
    if (!_clearButton) {
        ...
        [_clearButton setImage:LOADICON(@"CommureGateway", @"MKCGManageBleDevicesSearchButton", @"cg_clearButtonIcon.png") forState:UIControlStateNormal];
