//
//  MKCGManageBleDeviceSearchView.m
...
@interface MKCGManageBleDeviceSearchView ()<UIGestureRecognizerDelegate>
...
@implementation MKCGManageBleDeviceSearchView

- (void)dealloc{
    NSLog(@"MKCGManageBleDeviceSearchView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKCGManageBleDeviceSearchView *view = [[MKCGManageBleDeviceSearchView alloc] init];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"CommureGateway", @"MKCGManageBleDeviceSearchView", @"cg_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"CommureGateway", @"MKCGManageBleDeviceSearchView", @"cg_wifiGraySignalIcon.png");
    }
