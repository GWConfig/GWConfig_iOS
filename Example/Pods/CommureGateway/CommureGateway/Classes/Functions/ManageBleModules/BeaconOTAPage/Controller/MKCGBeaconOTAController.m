...
@interface MKCGBeaconOTAController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCGBeaconOTAPageModel *dataModel;
...
@implementation MKCGBeaconOTAController

- (void)dealloc {
    NSLog(@"MKCGBeaconOTAController销毁");
...
- (void)addNotes {
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(receiveDfuProgress:)
                                                 name:MKCGReceiveBxpButtonDfuProgressNotification
                                               object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(receiveDisconnect:)
                                                 name:MKCGReceiveGatewayDisconnectBXPButtonNotification
                                               object:nil];
}
...
- (MKCGBeaconOTAPageModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCGBeaconOTAPageModel alloc] init];
