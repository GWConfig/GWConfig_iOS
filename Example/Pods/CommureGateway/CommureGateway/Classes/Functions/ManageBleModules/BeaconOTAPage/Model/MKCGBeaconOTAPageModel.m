...
@interface MKCGBeaconOTAPageModel ()
...
@implementation MKCGBeaconOTAPageModel
...
- (BOOL)startOTA {
    ...
    [MKCGMQTTInterface cg_batchDfuBeacon:self.firmwareUrl dataFileUrl:self.dataUrl beaconList:@[@{
