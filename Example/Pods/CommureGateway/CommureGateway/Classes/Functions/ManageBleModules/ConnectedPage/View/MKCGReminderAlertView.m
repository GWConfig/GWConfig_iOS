...
@implementation MKCGReminderAlertViewModel
@end

@interface MKCGReminderColorButton : UIControl
...
@implementation MKCGReminderColorButton
...
- (UIImageView *)icon {
    if (!_icon) {
        ...
        _icon.image = LOADICON(@"CommureGateway", @"MKCGReminderColorButton", @"cg_resetByButtonUnselectedIcon.png");
    }
    return _icon;
}
...
@interface MKCGReminderAlertView ()
...
@property (nonatomic, strong)MKCGReminderColorButton *redColor;

@property (nonatomic, strong)MKCGReminderColorButton *blueColor;

@property (nonatomic, strong)MKCGReminderColorButton *greenColor;

@end

@implementation MKCGReminderAlertView
...
- (void)setupColorIcons {
    self.redColor.icon.image = (self.currentColor == 0 ? LOADICON(@"CommureGateway", @"MKCGReminderColorButton", @"cg_resetByButtonSelectedIcon.png") : LOADICON(@"CommureGateway", @"MKCGReminderColorButton", @"cg_resetByButtonUnselectedIcon.png"));
    self.blueColor.icon.image = (self.currentColor == 1 ? LOADICON(@"CommureGateway", @"MKCGReminderColorButton", @"cg_resetByButtonSelectedIcon.png") : LOADICON(@"CommureGateway", @"MKCGReminderColorButton", @"cg_resetByButtonUnselectedIcon.png"));
    self.greenColor.icon.image = (self.currentColor == 2 ? LOADICON(@"CommureGateway", @"MKCGReminderColorButton", @"cg_resetByButtonSelectedIcon.png") : LOADICON(@"CommureGateway", @"MKCGReminderColorButton", @"cg_resetByButtonUnselectedIcon.png"));
}
...
- (MKCGReminderColorButton *)redColor {
    if (!_redColor) {
        _redColor = [[MKCGReminderColorButton alloc] init];
...
- (MKCGReminderColorButton *)blueColor {
    if (!_blueColor) {
        _blueColor = [[MKCGReminderColorButton alloc] init];
...
- (MKCGReminderColorButton *)greenColor {
    if (!_greenColor) {
        _greenColor = [[MKCGReminderColorButton alloc] init];
