...
@interface MKCGAccelerometerModel ()
...
@implementation MKCGAccelerometerModel
...
- (BOOL)readAccelerometerParams {
    ...
    [MKCGMQTTInterface cg_readAccelerometerParamsWithBleMacAddress:self.bleMac macAddress:[MKCGDeviceModeManager shared].macAddress topic:[MKCGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (BOOL)configAccelerometerParams {
    __block BOOL success = NO;
    [MKCGMQTTInterface cg_configAccelerometerParamsWithBleMacAddress:self.bleMac sampleRate:self.sampleRate fullScale:self.fullScale sensitivity:[self.sensitivity integerValue] macAddress:[MKCGDeviceModeManager shared].macAddress topic:[MKCGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
