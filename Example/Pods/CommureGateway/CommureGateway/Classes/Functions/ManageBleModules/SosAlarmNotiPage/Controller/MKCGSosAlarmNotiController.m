...
@interface MKCGSosAlarmNotiController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCGSosAlarmNotiModel *dataModel;

@end

@implementation MKCGSosAlarmNotiController

- (void)dealloc {
    NSLog(@"MKCGSosAlarmNotiController销毁");
}
...
- (void)loadSection1Datas {
    ...
    cellModel2.textPlaceholder = (self.pageType == mk_cg_sosAlarmNotiPageType_normal ? @"1-255" : @"0-655");
    cellModel2.maxLength = 3;
    cellModel2.textFieldType = mk_realNumberOnly;
    cellModel2.textFieldValue = self.dataModel.ledDuration;
    cellModel2.unit = (self.pageType == mk_cg_sosAlarmNotiPageType_normal ? @"s" : @"x 100ms");
...
- (void)loadSubViews {
    ...
    self.defaultTitle = (self.pageType == mk_cg_sosAlarmNotiPageType_normal ? @"SOS alarm notifications" : @"Dismiss-SOS alarm notifications");
    [self.rightButton setImage:LOADICON(@"CommureGateway", @"MKCGSosAlarmNotiController", @"cg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCGSosAlarmNotiModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCGSosAlarmNotiModel alloc] init];
        _dataModel.bleMac = self.bleMac;
        _dataModel.dismiss = (self.pageType == mk_cg_sosAlarmNotiPageType_dismiss);
    }
    return _dataModel;
}
