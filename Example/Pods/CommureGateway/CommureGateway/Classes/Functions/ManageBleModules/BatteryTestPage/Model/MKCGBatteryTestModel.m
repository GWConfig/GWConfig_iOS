...
@interface MKCGBatteryTestModel ()
...
@implementation MKCGBatteryTestModel
...
- (BOOL)readBatteryParams {
    __block BOOL success = NO;
    [MKCGMQTTInterface cg_readBatterySelfTestWithBleMacAddress:self.bleMac macAddress:[MKCGDeviceModeManager shared].macAddress topic:[MKCGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        if ([returnData[@"data"][@"result_code"] integerValue] == 0) {
            //成功
            success = YES;
...
- (BOOL)readBatteryTestLedParams0 {
    __block BOOL success = NO;
    [MKCGMQTTInterface cg_readBatterySelfTestLedParamsWithMode:0 bleMacAddress:self.bleMac macAddress:[MKCGDeviceModeManager shared].macAddress topic:[MKCGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        if ([returnData[@"data"][@"result_code"] integerValue] == 0) {
            //成功
            success = YES;
...
- (BOOL)readBatteryTestLedParams1 {
    __block BOOL success = NO;
    [MKCGMQTTInterface cg_readBatterySelfTestLedParamsWithMode:1 bleMacAddress:self.bleMac macAddress:[MKCGDeviceModeManager shared].macAddress topic:[MKCGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        if ([returnData[@"data"][@"result_code"] integerValue] == 0) {
            //成功
            success = YES;
