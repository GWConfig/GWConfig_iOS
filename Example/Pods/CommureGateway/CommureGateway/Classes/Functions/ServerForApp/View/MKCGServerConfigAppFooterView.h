//
//  MKCGServerConfigAppFooterView.h
...
@interface MKCGServerConfigAppFooterViewModel : NSObject
...
@protocol MKCGServerConfigAppFooterViewDelegate <NSObject>
...
@interface MKCGServerConfigAppFooterView : UIView

@property (nonatomic, strong)MKCGServerConfigAppFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKCGServerConfigAppFooterViewDelegate>delegate;
