...
@implementation MKCGEasyShowView
...
- (UIImageView *)refreshIcon {
    if (!_refreshIcon) {
        ...
        _refreshIcon.image = LOADICON(@"CommureGateway", @"MKCGEasyShowView", @"cg_refreshIcon.png");
    }
    return _refreshIcon;
}
