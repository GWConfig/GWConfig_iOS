...
@interface MKCGBatchUpdateKeyModel ()
...
- (BOOL)configDatas:(NSArray *)list {
    ...
    [MKCGMQTTInterface cg_batchUpdateKey:self.encryptionKey beaconList:dfuList macAddress:[MKCGDeviceModeManager shared].macAddress topic:[MKCGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
