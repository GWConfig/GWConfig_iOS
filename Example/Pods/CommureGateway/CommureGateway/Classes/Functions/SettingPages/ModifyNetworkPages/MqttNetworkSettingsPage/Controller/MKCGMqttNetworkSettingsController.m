//
//  MKCGMqttNetworkSettingsController.m
...
@interface MKCGMqttNetworkSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCGMqttNetworkSettingsModel *dataModel;

@end

@implementation MKCGMqttNetworkSettingsController

- (void)dealloc {
    NSLog(@"MKCGMqttNetworkSettingsController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGateway", @"MKCGMqttNetworkSettingsController", @"cg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCGMqttNetworkSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCGMqttNetworkSettingsModel alloc] init];
    }
    return _dataModel;
}
