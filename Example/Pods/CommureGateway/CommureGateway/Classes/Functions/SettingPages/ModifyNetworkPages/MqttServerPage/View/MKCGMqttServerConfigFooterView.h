//
//  MKCGMqttServerConfigFooterView.h
...
@interface MKCGMqttServerConfigFooterViewModel : NSObject
...
@protocol MKCGMqttServerConfigFooterViewDelegate <NSObject>
...
@interface MKCGMqttServerConfigFooterView : UIView

@property (nonatomic, strong)MKCGMqttServerConfigFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKCGMqttServerConfigFooterViewDelegate>delegate;
