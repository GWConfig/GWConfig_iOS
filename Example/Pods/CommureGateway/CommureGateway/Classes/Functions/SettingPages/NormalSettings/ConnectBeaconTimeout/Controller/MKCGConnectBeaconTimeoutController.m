//
//  MKCGConnectBeaconTimeoutController.m
...
@interface MKCGConnectBeaconTimeoutController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCGConnectBeaconTimeoutModel *dataModel;

@end

@implementation MKCGConnectBeaconTimeoutController

- (void)dealloc {
    NSLog(@"MKCGConnectBeaconTimeoutController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGateway", @"MKCGConnectBeaconTimeoutController", @"cg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCGConnectBeaconTimeoutModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCGConnectBeaconTimeoutModel alloc] init];
    }
    return _dataModel;
}
