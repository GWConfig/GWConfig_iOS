...
@interface MKCGCommunicateController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCGCommunicateModel *dataModel;

@end

@implementation MKCGCommunicateController

- (void)dealloc {
    NSLog(@"MKCGCommunicateController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGateway", @"MKCGCommunicateController", @"cg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCGCommunicateModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCGCommunicateModel alloc] init];
    }
    return _dataModel;
}
