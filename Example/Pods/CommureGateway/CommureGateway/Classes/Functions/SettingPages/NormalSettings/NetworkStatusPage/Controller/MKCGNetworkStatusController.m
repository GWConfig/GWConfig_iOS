...
@interface MKCGNetworkStatusController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCGNetworkStatusModel *dataModel;

@end

@implementation MKCGNetworkStatusController

- (void)dealloc {
    NSLog(@"MKCGNetworkStatusController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGateway", @"MKCGNetworkStatusController", @"cg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCGNetworkStatusModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCGNetworkStatusModel alloc] init];
    }
    return _dataModel;
}
