...
@interface MKCGDataReportController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCGDataReportModel *dataModel;

@end

@implementation MKCGDataReportController

- (void)dealloc {
    NSLog(@"MKCGDataReportController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGateway", @"MKCGDataReportController", @"cg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCGDataReportModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCGDataReportModel alloc] init];
    }
    return _dataModel;
}
