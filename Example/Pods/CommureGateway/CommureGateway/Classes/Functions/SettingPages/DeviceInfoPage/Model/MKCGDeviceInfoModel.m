...
@implementation MKCGDeviceInfoModel
...
- (BOOL)readDeviceInfo {
    ...
    [MKCGMQTTInterface cg_readDeviceInfoWithMacAddress:[MKCGDeviceModeManager shared].macAddress topic:[MKCGDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        ...
        self.wifiStaMac = [MKCGDeviceModeManager shared].macAddress;
