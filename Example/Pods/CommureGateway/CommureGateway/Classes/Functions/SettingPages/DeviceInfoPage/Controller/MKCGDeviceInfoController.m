...
@interface MKCGDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCGDeviceInfoModel *dataModel;

@end

@implementation MKCGDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCGDeviceInfoController销毁");
}
...
- (MKCGDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCGDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
