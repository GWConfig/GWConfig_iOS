//
//  MKCGBleMqttConfigSelectModel.m
...
@interface MKCGBleMqttConfigSelectModel ()
...
@implementation MKCGBleMqttConfigSelectModel
...
- (BOOL)downCAData:(NSString *)filePath {
    NSString *caPath = [self filePathWithName:@"ca.pem"];
...
- (BOOL)downClientCertData:(NSString *)filePath {
    NSString *clientCertPath = [self filePathWithName:@"certificate.pem.crt"];
...
- (BOOL)downClientKeyData:(NSString *)filePath {
    NSString *clientKeyPath = [self filePathWithName:@"private.pem.key"];
...
- (BOOL)downWifiCAData:(NSString *)filePath {
    NSString *wifiCaPath = [self filePathWithName:@"wifi_ca.pem"];
...
- (BOOL)downWifiClientCertData:(NSString *)filePath {
    NSString *wifiClientCertPath = [self filePathWithName:@"wifi_client.crt"];
...
- (BOOL)downWifiClientKeyData:(NSString *)filePath {
    NSString *wifiClientKeyPath = [self filePathWithName:@"wifi_client.key"];
