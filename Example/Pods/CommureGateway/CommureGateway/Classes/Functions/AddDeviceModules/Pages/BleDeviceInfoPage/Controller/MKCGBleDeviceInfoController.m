...
@interface MKCGBleDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCGBleDeviceInfoModel *dataModel;

@end

@implementation MKCGBleDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCGBleDeviceInfoController销毁");
...
- (MKCGBleDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCGBleDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
