...
@implementation MKCGBatchModifyTableHeader
...
- (UIButton *)excelButton {
    if (!_excelButton) {
        ...
        [_excelButton setImage:LOADICON(@"CommureGateway", @"MKCGBatchModifyTableHeader", @"cg_batchOtaListSelectIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)scanButton {
    if (!_scanButton) {
        ...
        [_scanButton setImage:LOADICON(@"CommureGateway", @"MKCGBatchModifyTableHeader", @"cg_batchOtaQRCodeIcon.png") forState:UIControlStateNormal];
