...
@interface MKCGTimeOffsetController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCGTimeOffsetModel *dataModel;

@end

@implementation MKCGTimeOffsetController

- (void)dealloc {
    NSLog(@"MKCGTimeOffsetController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGateway", @"MKCGTimeOffsetController", @"cg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCGTimeOffsetModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCGTimeOffsetModel alloc] init];
    }
    return _dataModel;
}
