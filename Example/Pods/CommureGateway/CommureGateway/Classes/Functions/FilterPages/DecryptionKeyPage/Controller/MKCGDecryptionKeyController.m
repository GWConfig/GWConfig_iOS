...
@interface MKCGDecryptionKeyController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCGDecryptionKeyModel *dataModel;

@end

@implementation MKCGDecryptionKeyController

- (void)dealloc {
    NSLog(@"MKCGDecryptionKeyController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"CommureGateway", @"MKCGDecryptionKeyController", @"cg_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCGDecryptionKeyModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCGDecryptionKeyModel alloc] init];
    }
    return _dataModel;
}
