//
//  MKCGConfiguredGatewayHeaderView.m
...
@interface MKCGConfiguredGatewayHeaderView ()
...
@implementation MKCGConfiguredGatewayHeaderView
...
- (UIButton *)excelButton {
    if (!_excelButton) {
        ...
        [_excelButton setImage:LOADICON(@"CommureGateway", @"MKCGConfiguredGatewayHeaderView", @"cg_batchOtaListSelectIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)scanButton {
    if (!_scanButton) {
        ...
        [_scanButton setImage:LOADICON(@"CommureGateway", @"MKCGConfiguredGatewayHeaderView", @"cg_batchOtaQRCodeIcon.png") forState:UIControlStateNormal];
