...
typedef NS_ENUM(NSInteger, MKCGDeviceModelState) {
    MKCGDeviceModelStateOffline,
    MKCGDeviceModelStateOnline,
};

//当设备离线的时候发出通知
extern NSString *const MKCGDeviceModelOfflineNotification;

@protocol MKCGDeviceModelDelegate <NSObject>
...
@interface MKCGDeviceModel : NSObject<MKCGDeviceModeManagerDataProtocol>
...
/**
 设备的状态，离线、在线
 */
@property (nonatomic, assign)MKCGDeviceModelState onLineState;

#pragma mark - 业务流程相关

@property (nonatomic, weak)id <MKCGDeviceModelDelegate>delegate;
