...
@interface MKCGImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKCGImportServerController

- (void)dealloc {
    NSLog(@"MKCGImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(cg_selectedServerParams:)]) {
        [self.delegate cg_selectedServerParams:model.leftMsg];
    }
