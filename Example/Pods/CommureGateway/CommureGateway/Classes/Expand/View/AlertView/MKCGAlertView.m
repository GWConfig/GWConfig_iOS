...
@implementation MKCGAlertViewModel
@end

@interface MKCGAlertView ()
...
@implementation MKCGAlertView

- (void)dealloc {
    NSLog(@"MKCGAlertView销毁");
}
...
- (void)showWithModel:(MKCGAlertViewModel *)dataModel
         cancelAction:(void (^)(void))cancelBlock
        confirmAction:(void (^)(void))confirmBlock {
    if (!dataModel || ![dataModel isKindOfClass:MKCGAlertViewModel.class]) {
        return;
    }
