...
extern NSString *const mk_cg_centralManagerStateChangedNotification;
 ...
 */
extern NSString *const mk_cg_deviceDisconnectTypeNotification;

@class CBCentralManager,CBPeripheral;
@class MKCGOperation;

@interface MKCGCentralManager : NSObject<MKBLEBaseCentralManagerProtocol>
