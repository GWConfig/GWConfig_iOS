...
@interface MKCGMQTTInterface : NSObject
...
/// @param sensitivity 0~255.If the fullScale is mk_cg_threeAxisDataFullScale0,unit of sensitivity is 3.91mg. If the fullScale is mk_cg_threeAxisDataFullScale1,unit of sensitivity is 7.81mg. If the fullScale is mk_cg_threeAxisDataFullScale2,unit of sensitivity is 15.63mg. If the fullScale is mk_cg_threeAxisDataFullScale3,unit of sensitivity is 31.25mg.
/// @param macAddress WIFI_STA Mac address of the device.(e.g.AABBCCDDEEFF)
/// @param topic topic 1-128 Characters
/// @param sucBlock Success callback
/// @param failedBlock Failed callback
