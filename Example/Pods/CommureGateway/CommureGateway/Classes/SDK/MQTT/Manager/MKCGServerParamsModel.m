...
static NSString *const fileName = @"MKCGServerParams.txt";

@interface MKCGServerParamsModel ()
...
@implementation MKCGServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKCGServerParamsProtocol>)protocol {
