...
@implementation MKCommureAboutCellModel
@end

@interface MKCommureAboutCell ()
...
@implementation MKCommureAboutCell

+ (MKCommureAboutCell *)initCellWithTableView:(UITableView *)table {
    MKCommureAboutCell *cell = [table dequeueReusableCellWithIdentifier:@"MKCommureAboutCellIdenty"];
    if (!cell) {
        cell = [[MKCommureAboutCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCommureAboutCellIdenty"];
    }
    return cell;
}
...
#pragma mark -
- (void)setDataModel:(MKCommureAboutCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCommureAboutCellModel.class]) {
        return;
    }
