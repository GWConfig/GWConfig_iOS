           ...
           sss.subspec 'Pages' do |ssss|
               ...
               ssss.subspec 'BleWifiSettingsPage' do |sssss|
                   sssss.subspec 'Controller' do |ssssss|
                     ...
                     ssssss.dependency 'MKCommureApp/Functions/AddDeviceModules/Pages/BleWifiSettingsPage/View'
                   end
                   ...
                   sssss.subspec 'View' do |ssssss|
                     ssssss.source_files = 'MKCommureApp/Classes/Functions/AddDeviceModules/Pages/BleWifiSettingsPage/View/**'
                   end
               end
