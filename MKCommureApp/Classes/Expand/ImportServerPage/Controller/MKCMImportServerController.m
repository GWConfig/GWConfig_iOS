...
@interface MKCMImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKCMImportServerController

- (void)dealloc {
    NSLog(@"MKCMImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(cm_selectedServerParams:)]) {
        [self.delegate cm_selectedServerParams:model.leftMsg];
    }
