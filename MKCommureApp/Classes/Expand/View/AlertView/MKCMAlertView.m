...
@implementation MKCMAlertViewModel
@end

@interface MKCMAlertView ()
...
@implementation MKCMAlertView

- (void)dealloc {
    NSLog(@"MKCMAlertView销毁");
}
...
- (void)showWithModel:(MKCMAlertViewModel *)dataModel
         cancelAction:(void (^)(void))cancelBlock
        confirmAction:(void (^)(void))confirmBlock {
    if (!dataModel || ![dataModel isKindOfClass:MKCMAlertViewModel.class]) {
        return;
    }
