...
#pragma mark - Config
    ...
    mk_cm_server_taskModifyWifiNetworkInfoOperation,        //配置Wifi网络参数
    mk_cm_server_taskModifyNetworkTypeOperation,            //配置网络接口类型
    mk_cm_server_taskModifyEthernetNetworkInfoOperation,    //配置Ethernet网络参数
...
#pragma mark - Read
    ...
    mk_cm_server_taskReadWifiNetworkInfosOperation,                 //读取Wifi网络参数
    mk_cm_server_taskReadNetworkTypeOperation,                  //读取网络接口选择
    mk_cm_server_taskReadEthernetNetworkInfosOperation,         //读取读取Ethernet网络参数
