...
static NSString *const fileName = @"MKCMServerParams.txt";

@interface MKCMServerParamsModel ()
...
@implementation MKCMServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKCMServerParamsProtocol>)protocol {
