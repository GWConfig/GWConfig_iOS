...
+ (void)cm_configDeviceTime:(unsigned long)timestamp
    ...
    [self configDataWithTaskID:mk_cm_taskConfigDeviceTimeOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)cm_configWIFIDHCPStatus:(BOOL)isOn
    ...
    [self configDataWithTaskID:mk_cm_taskConfigWIFIDHCPStatusOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)cm_configWIFIIpAddress:(NSString *)ip
    ...
    [self configDataWithTaskID:mk_cm_taskConfigWIFIIpInfoOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)cm_configNetworkType:(mk_cm_networkType)type
    ...
    [self configDataWithTaskID:mk_cm_taskConfigNetworkTypeOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)cm_configEthernetDHCPStatus:(BOOL)isOn
    ...
    [self configDataWithTaskID:mk_cm_taskConfigEthernetDHCPStatusOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)cm_configEthernetIpAddress:(NSString *)ip
    ...
    [self configDataWithTaskID:mk_cm_taskConfigEthernetIpInfoOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
...
+ (void)cm_configCountryBand:(NSInteger)parameter
    ...
    [self configDataWithTaskID:mk_cm_taskConfigCountryBandOperation
                          data:commandString
                      sucBlock:sucBlock
                   failedBlock:failedBlock];
}
