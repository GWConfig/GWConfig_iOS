...
extern NSString *const mk_cm_peripheralConnectStateChangedNotification;

//Notification of changes in the status of the Bluetooth Center.
extern NSString *const mk_cm_centralManagerStateChangedNotification;
 ...
 */
extern NSString *const mk_cm_deviceDisconnectTypeNotification;

@class CBCentralManager,CBPeripheral;
@class MKCMOperation;

@interface MKCMCentralManager : NSObject<MKBLEBaseCentralManagerProtocol>

@property (nonatomic, weak)id <mk_cm_centralManagerScanDelegate>delegate;

/// Current connection status
@property (nonatomic, assign, readonly)mk_cm_centralConnectStatus connectStatus;
