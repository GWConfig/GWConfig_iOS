...
+ (void)cm_readDHCPStatusWithSucBlock:(void (^)(id returnData))sucBlock
                          failedBlock:(void (^)(NSError *error))failedBlock {
    NSString *commandString = @"ed004b00";
    [centralManager addTaskWithTaskID:mk_cm_taskReadDHCPStatusOperation
                       characteristic:peripheral.cm_custom
                          commandData:commandString
                         successBlock:sucBlock
                         failureBlock:failedBlock];
...
+ (void)cm_readNetworkIpInfosWithSucBlock:(void (^)(id returnData))sucBlock
    ...
    [centralManager addTaskWithTaskID:mk_cm_taskReadNetworkIpInfosOperation
                       characteristic:peripheral.cm_custom
                          commandData:commandString
                         successBlock:sucBlock
                         failureBlock:failedBlock];
...
+ (void)cm_readRssiFilterValueWithSucBlock:(void (^)(id returnData))sucBlock
    ...
    [centralManager addTaskWithTaskID:mk_cm_taskReadRssiFilterValueOperation
                       characteristic:peripheral.cm_custom
                          commandData:commandString
                         successBlock:sucBlock
                         failureBlock:failedBlock];
...
+ (void)cm_readFilterRelationshipWithSucBlock:(void (^)(id returnData))sucBlock
    ...
    [centralManager addTaskWithTaskID:mk_cm_taskReadFilterRelationshipOperation
                       characteristic:peripheral.cm_custom
                          commandData:commandString
                         successBlock:sucBlock
                         failureBlock:failedBlock];
...
+ (void)cm_readFilterMACAddressListWithSucBlock:(void (^)(id returnData))sucBlock
    ...
    [centralManager addTaskWithTaskID:mk_cm_taskReadFilterMACAddressListOperation
                       characteristic:peripheral.cm_custom
                          commandData:commandString
                         successBlock:sucBlock
                         failureBlock:failedBlock];
...
+ (void)cm_readFilterAdvNameListWithSucBlock:(void (^)(id returnData))sucBlock
    ...
    [centralManager addTaskWithTaskID:mk_cm_taskReadFilterAdvNameListOperation
                       characteristic:peripheral.cm_custom
                          commandData:commandString
                         successBlock:^(id  _Nonnull returnData) {
        NSArray *advList = [MKCMSDKDataAdopter parseFilterAdvNameList:returnData[@"result"]];
        NSDictionary *resultDic = @{@"msg":@"success",
                                    @"code":@"1",
                                    @"result":@{
                                        @"nameList":advList,
