...
@interface MKDecryptionKeyController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKDecryptionKeyModel *dataModel;

@end

@implementation MKDecryptionKeyController

- (void)dealloc {
    NSLog(@"MKDecryptionKeyController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKCommureApp", @"MKDecryptionKeyController", @"cm_saveIcon.png") forState:UIControlStateNormal];
...
- (MKDecryptionKeyModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKDecryptionKeyModel alloc] init];
    }
    return _dataModel;
}
