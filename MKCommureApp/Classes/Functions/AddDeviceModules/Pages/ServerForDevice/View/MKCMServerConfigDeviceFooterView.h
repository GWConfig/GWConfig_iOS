//
//  MKCMServerConfigDeviceFooterView.h
...
@interface MKCMServerConfigDeviceFooterViewModel : NSObject
...
@protocol MKCMServerConfigDeviceFooterViewDelegate <NSObject>
...
@interface MKCMServerConfigDeviceFooterView : UIView

@property (nonatomic, strong)MKCMServerConfigDeviceFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKCMServerConfigDeviceFooterViewDelegate>delegate;
