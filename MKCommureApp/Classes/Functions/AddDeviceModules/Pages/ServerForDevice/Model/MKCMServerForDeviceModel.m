...
@interface MKCMServerForDeviceModel ()
...
@implementation MKCMServerForDeviceModel
...
- (void)updateValue:(MKCMServerForDeviceModel *)model {
    if (!model || ![model isKindOfClass:MKCMServerForDeviceModel.class]) {
        return;
    }
...
- (BOOL)readDeviceMac {
    ...
    [MKCMInterface cm_readDeviceWifiSTAMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readDeviceName {
    __block BOOL success = NO;
    [MKCMInterface cm_readDeviceNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHost {
    __block BOOL success = NO;
    [MKCMInterface cm_readServerHostWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configHost {
    __block BOOL success = NO;
    [MKCMInterface cm_configServerHost:self.host sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPort {
    __block BOOL success = NO;
    [MKCMInterface cm_readServerPortWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPort {
    __block BOOL success = NO;
    [MKCMInterface cm_configServerPort:[self.port integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readClientID {
    __block BOOL success = NO;
    [MKCMInterface cm_readClientIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configClientID {
    __block BOOL success = NO;
    [MKCMInterface cm_configClientID:self.clientID sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readUsername {
    __block BOOL success = NO;
    [MKCMInterface cm_readServerUserNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configUserName {
    __block BOOL success = NO;
    [MKCMInterface cm_configServerUserName:self.userName sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPassword {
    __block BOOL success = NO;
    [MKCMInterface cm_readServerPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPassword {
    __block BOOL success = NO;
    [MKCMInterface cm_configServerPassword:self.password sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readCleanSession {
    __block BOOL success = NO;
    [MKCMInterface cm_readServerCleanSessionWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configCleanSession {
    __block BOOL success = NO;
    [MKCMInterface cm_configServerCleanSession:self.cleanSession sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readKeepAlive {
    __block BOOL success = NO;
    [MKCMInterface cm_readServerKeepAliveWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configKeepAlive {
    __block BOOL success = NO;
    [MKCMInterface cm_configServerKeepAlive:[self.keepAlive integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readQos {
    __block BOOL success = NO;
    [MKCMInterface cm_readServerQosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configQos {
    __block BOOL success = NO;
    [MKCMInterface cm_configServerQos:self.qos sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readSubscribe {
    __block BOOL success = NO;
    [MKCMInterface cm_readSubscibeTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSubscribe {
    ...
    [MKCMInterface cm_configSubscibeTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)readPublish {
    __block BOOL success = NO;
    [MKCMInterface cm_readPublishTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPublish {
    ...
    [MKCMInterface cm_configPublishTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)readSSLStatus {
    __block BOOL success = NO;
    [MKCMInterface cm_readConnectModeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSSLStatus {
    __block BOOL success = NO;
    mk_cm_connectMode mode = mk_cm_connectMode_TCP;
    if (self.sslIsOn) {
        if (self.certificate == 0) {
            mode = mk_cm_connectMode_CASignedServerCertificate;
        }else if (self.certificate == 1) {
            mode = mk_cm_connectMode_CACertificate;
        }else if (self.certificate == 2) {
            mode = mk_cm_connectMode_SelfSignedCertificates;
        }
    }
    [MKCMInterface cm_configConnectMode:mode sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configCAFile {
    ...
    [MKCMInterface cm_configCAFile:caData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientKey {
    ...
    [MKCMInterface cm_configClientPrivateKey:clientKeyData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientCert {
    ...
    [MKCMInterface cm_configClientCert:clientCertData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
