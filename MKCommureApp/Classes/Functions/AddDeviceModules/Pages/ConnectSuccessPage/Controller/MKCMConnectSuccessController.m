//
//  MKCMConnectSuccessController.m
...
@interface MKCMConnectSuccessController ()
...
@implementation MKCMConnectSuccessController

- (void)dealloc {
    NSLog(@"MKCMConnectSuccessController销毁");
}
...
- (void)saveButtonPressed {
    ...
    [MKCMDeviceDatabaseManager insertDeviceList:@[self.deviceModel] sucBlock:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_cm_addNewDeviceSuccessNotification"
                                                            object:nil
