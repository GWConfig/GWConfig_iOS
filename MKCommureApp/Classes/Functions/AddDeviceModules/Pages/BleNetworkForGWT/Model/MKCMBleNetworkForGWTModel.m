...
@interface MKCMBleNetworkForGWTModel ()
...
@implementation MKCMBleNetworkForGWTModel
...
- (BOOL)readNetworkType {
    ...
    [MKCMInterface cm_readNetworkTypeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNetworkType {
    __block BOOL success = NO;
    [MKCMInterface cm_configNetworkType:self.networkType sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiDHCPStatus {
    __block BOOL success = NO;
    [MKCMInterface cm_readWIFIDHCPStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiDHCPStatus {
    __block BOOL success = NO;
    [MKCMInterface cm_configWIFIDHCPStatus:self.wifi_dhcp sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiIpAddress {
    __block BOOL success = NO;
    [MKCMInterface cm_readWIFINetworkIpInfosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiIpAddress {
    __block BOOL success = NO;
    [MKCMInterface cm_configWIFIIpAddress:self.wifi_ip
                                     mask:self.wifi_mask
...
- (BOOL)readEthernetDHCPStatus {
    __block BOOL success = NO;
    [MKCMInterface cm_readEthernetDHCPStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEthernetDHCPStatus {
    __block BOOL success = NO;
    [MKCMInterface cm_configEthernetDHCPStatus:self.ethernet_dhcp sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEthernetIpAddress {
    __block BOOL success = NO;
    [MKCMInterface cm_readEthernetNetworkIpInfosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEthernetIpAddress {
    __block BOOL success = NO;
    [MKCMInterface cm_configWIFIIpAddress:self.ethernet_ip
