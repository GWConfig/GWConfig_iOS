...
@interface MKCMBleDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCMBleDeviceInfoModel *dataModel;

@end

@implementation MKCMBleDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCMBleDeviceInfoController销毁");
...
- (MKCMBleDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCMBleDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
