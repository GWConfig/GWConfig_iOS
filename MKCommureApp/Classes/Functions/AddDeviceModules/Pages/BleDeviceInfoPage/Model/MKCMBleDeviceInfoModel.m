...
@interface MKCMBleDeviceInfoModel ()
...
@implementation MKCMBleDeviceInfoModel
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKCMInterface cm_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKCMInterface cm_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKCMInterface cm_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKCMInterface cm_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKCMInterface cm_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readMacAddress {
    __block BOOL success = NO;
    [MKCMInterface cm_readMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
