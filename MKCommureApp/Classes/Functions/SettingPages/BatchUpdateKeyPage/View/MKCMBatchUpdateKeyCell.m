...
- (NSString *)statusMsg {
    switch (self.dataModel.status) {
        case mk_cm_batchUpdateKeyStatus_normal:
            return @"Wait";
        case mk_cm_batchUpdateKeyStatus_upgrading:
            return @"Upgrading";
        case mk_cm_batchUpdateKeyStatus_success:
            return @"Success";
        case mk_cm_batchUpdateKeyStatus_failed:
            return @"Failed";
    }
}
