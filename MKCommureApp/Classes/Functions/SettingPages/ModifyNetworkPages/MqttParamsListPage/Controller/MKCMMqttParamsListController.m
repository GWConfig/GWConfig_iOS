//
//  MKCMMqttParamsListController.m
...
@interface MKCMMqttParamsListController ()<UITableViewDelegate, UITableViewDataSource>
...
@property (nonatomic, strong)MKCMMqttParamsModel *dataModel;

@end

@implementation MKCMMqttParamsListController

- (void)dealloc {
    NSLog(@"MKCMMqttParamsListController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0 && indexPath.row == 0) {
        //WIFI Settings
        MKCMMqttWifiSettingsController *vc = [[MKCMMqttWifiSettingsController alloc] init];
    ...
    if (indexPath.section == 0 && indexPath.row == 2) {
        //Network Settings
        MKCMMqttNetworkSettingsController *vc = [[MKCMMqttNetworkSettingsController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
}
...
- (MKCMMqttParamsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCMMqttParamsModel alloc] init];
    }
    return _dataModel;
}
