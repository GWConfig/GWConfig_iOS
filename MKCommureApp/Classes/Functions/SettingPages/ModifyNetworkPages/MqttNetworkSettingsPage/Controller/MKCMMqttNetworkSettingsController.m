//
//  MKCMMqttNetworkSettingsController.m
...
@interface MKCMMqttNetworkSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCMMqttNetworkSettingsModel *dataModel;

@end

@implementation MKCMMqttNetworkSettingsController

- (void)dealloc {
    NSLog(@"MKCMMqttNetworkSettingsController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKCommureApp", @"MKCMMqttNetworkSettingsController", @"cm_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCMMqttNetworkSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCMMqttNetworkSettingsModel alloc] init];
    }
    return _dataModel;
}
