//
//  MKCMMqttNetworkSettingForGWTModel.h
...
@interface MKCMMqttNetworkSettingForGWTModel : NSObject<mk_cm_mqttModifyWifiProtocol,
mk_cm_mqttModifyWifiEapCertProtocol>
