...
@interface MKCMOTAController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCMOTAPageModel *dataModel;

@end

@implementation MKCMOTAController

- (void)dealloc {
    NSLog(@"MKCMOTAController销毁");
...
- (MKCMOTAPageModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCMOTAPageModel alloc] init];
    }
    return _dataModel;
}
