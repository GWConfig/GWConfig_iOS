...
@interface MKCMDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCMDeviceInfoModel *dataModel;

@end

@implementation MKCMDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCMDeviceInfoController销毁");
}
...
- (MKCMDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCMDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
