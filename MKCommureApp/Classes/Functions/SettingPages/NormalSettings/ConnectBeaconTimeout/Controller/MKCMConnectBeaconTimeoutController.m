//
//  MKCMConnectBeaconTimeoutController.m
...
@interface MKCMConnectBeaconTimeoutController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCMConnectBeaconTimeoutModel *dataModel;

@end

@implementation MKCMConnectBeaconTimeoutController

- (void)dealloc {
    NSLog(@"MKCMConnectBeaconTimeoutController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKCommureApp", @"MKCMConnectBeaconTimeoutController", @"cm_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCMConnectBeaconTimeoutModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCMConnectBeaconTimeoutModel alloc] init];
    }
    return _dataModel;
}
