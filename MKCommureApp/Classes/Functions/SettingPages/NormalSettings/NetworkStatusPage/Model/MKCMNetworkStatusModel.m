...
@interface MKCMNetworkStatusModel ()
...
@implementation MKCMNetworkStatusModel
...
- (BOOL)readReportInterval {
    ...
    [MKCMMQTTInterface cm_readNetworkStatusReportIntervalWithMacAddress:[MKCMDeviceModeManager shared].macAddress topic:[MKCMDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configReportInterval {
    __block BOOL success = NO;
    [MKCMMQTTInterface cm_configNetworkStatusReportInterval:[self.interval integerValue] macAddress:[MKCMDeviceModeManager shared].macAddress topic:[MKCMDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
