...
@interface MKCMDataReportController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCMDataReportModel *dataModel;

@end

@implementation MKCMDataReportController

- (void)dealloc {
    NSLog(@"MKCMDataReportController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKCommureApp", @"MKCMDataReportController", @"cm_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCMDataReportModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCMDataReportModel alloc] init];
    }
    return _dataModel;
}
