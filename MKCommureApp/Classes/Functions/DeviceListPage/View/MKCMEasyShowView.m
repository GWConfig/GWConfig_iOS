...
@implementation MKCMEasyShowView
...
- (UIImageView *)refreshIcon {
    if (!_refreshIcon) {
        ...
        _refreshIcon.image = LOADICON(@"MKCommureApp", @"MKCMEasyShowView", @"cm_refreshIcon.png");
    }
    return _refreshIcon;
}
