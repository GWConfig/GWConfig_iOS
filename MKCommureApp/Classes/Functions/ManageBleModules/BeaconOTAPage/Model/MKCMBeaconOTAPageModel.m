...
@interface MKCMBeaconOTAPageModel ()
...
@implementation MKCMBeaconOTAPageModel
...
- (BOOL)startOTA {
    ...
    [MKCMMQTTInterface cm_batchDfuBeacon:self.firmwareUrl dataFileUrl:self.dataUrl beaconList:@[@{
