//
//  MKCMManageBleDevicesSearchButton.m
...
@implementation MKCMManageBleDevicesSearchButtonModel
@end

@interface MKCMManageBleDevicesSearchButton ()
...
@implementation MKCMManageBleDevicesSearchButton
...
- (void)clearButtonPressed{
    ...
    if ([self.delegate respondsToSelector:@selector(cm_scanSearchButtonClearMethod)]) {
        [self.delegate cm_scanSearchButtonClearMethod];
    }
}

- (void)searchButtonPressed{
    if ([self.delegate respondsToSelector:@selector(cm_scanSearchButtonMethod)]) {
        [self.delegate cm_scanSearchButtonMethod];
    }
}

#pragma mark - setting
- (void)setDataModel:(MKCMManageBleDevicesSearchButtonModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCMManageBleDevicesSearchButtonModel.class]) {
        return;
    }
...
- (UIImageView *)searchIcon{
    if (!_searchIcon) {
        ...
        _searchIcon.image = LOADICON(@"MKCommureApp", @"MKCMManageBleDevicesSearchButton", @"cm_searchGrayIcon.png");
    }
    return _searchIcon;
}
...
- (UIButton *)clearButton{
    if (!_clearButton) {
        ...
        [_clearButton setImage:LOADICON(@"MKCommureApp", @"MKCMManageBleDevicesSearchButton", @"cm_clearButtonIcon.png") forState:UIControlStateNormal];
