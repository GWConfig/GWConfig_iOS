//
//  MKCMManageBleDeviceSearchView.m
...
@interface MKCMManageBleDeviceSearchView ()<UIGestureRecognizerDelegate>
...
@implementation MKCMManageBleDeviceSearchView

- (void)dealloc{
    NSLog(@"MKCMManageBleDeviceSearchView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKCMManageBleDeviceSearchView *view = [[MKCMManageBleDeviceSearchView alloc] init];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"MKCommureApp", @"MKCMManageBleDeviceSearchView", @"cm_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"MKCommureApp", @"MKCMManageBleDeviceSearchView", @"cm_wifiGraySignalIcon.png");
    }
