...
@interface MKCMAccelerometerModel ()
...
@implementation MKCMAccelerometerModel
...
- (BOOL)readAccelerometerParams {
    ...
    [MKCMMQTTInterface cm_readAccelerometerParamsWithBleMacAddress:self.bleMac macAddress:[MKCMDeviceModeManager shared].macAddress topic:[MKCMDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (BOOL)configAccelerometerParams {
    __block BOOL success = NO;
    [MKCMMQTTInterface cm_configAccelerometerParamsWithBleMacAddress:self.bleMac sampleRate:self.sampleRate fullScale:self.fullScale sensitivity:[self.sensitivity integerValue] macAddress:[MKCMDeviceModeManager shared].macAddress topic:[MKCMDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
