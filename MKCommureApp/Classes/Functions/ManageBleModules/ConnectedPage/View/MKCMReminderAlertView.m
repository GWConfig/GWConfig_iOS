...
@implementation MKCMReminderAlertViewModel
@end

@interface MKCMReminderColorButton : UIControl
...
@implementation MKCMReminderColorButton
...
- (UIImageView *)icon {
    if (!_icon) {
        ...
        _icon.image = LOADICON(@"MKCommureApp", @"MKCMReminderColorButton", @"cm_resetByButtonUnselectedIcon.png");
    }
    return _icon;
}
...
@interface MKCMReminderAlertView ()
...
@property (nonatomic, strong)MKCMReminderColorButton *redColor;

@property (nonatomic, strong)MKCMReminderColorButton *blueColor;

@property (nonatomic, strong)MKCMReminderColorButton *greenColor;

@end

@implementation MKCMReminderAlertView
...
- (void)setupColorIcons {
    self.redColor.icon.image = (self.currentColor == 0 ? LOADICON(@"MKCommureApp", @"MKCMReminderColorButton", @"cm_resetByButtonSelectedIcon.png") : LOADICON(@"MKCommureApp", @"MKCMReminderColorButton", @"cm_resetByButtonUnselectedIcon.png"));
    self.blueColor.icon.image = (self.currentColor == 1 ? LOADICON(@"MKCommureApp", @"MKCMReminderColorButton", @"cm_resetByButtonSelectedIcon.png") : LOADICON(@"MKCommureApp", @"MKCMReminderColorButton", @"cm_resetByButtonUnselectedIcon.png"));
    self.greenColor.icon.image = (self.currentColor == 2 ? LOADICON(@"MKCommureApp", @"MKCMReminderColorButton", @"cm_resetByButtonSelectedIcon.png") : LOADICON(@"MKCommureApp", @"MKCMReminderColorButton", @"cm_resetByButtonUnselectedIcon.png"));
}
...
- (MKCMReminderColorButton *)redColor {
    if (!_redColor) {
        _redColor = [[MKCMReminderColorButton alloc] init];
...
- (MKCMReminderColorButton *)blueColor {
    if (!_blueColor) {
        _blueColor = [[MKCMReminderColorButton alloc] init];
...
- (MKCMReminderColorButton *)greenColor {
    if (!_greenColor) {
        _greenColor = [[MKCMReminderColorButton alloc] init];
