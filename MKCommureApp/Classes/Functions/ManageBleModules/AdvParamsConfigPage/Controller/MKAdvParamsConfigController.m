...
@interface MKAdvParamsConfigController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKAdvParamsConfigModel *dataModel;

@end

@implementation MKAdvParamsConfigController

- (void)dealloc {
    NSLog(@"MKAdvParamsConfigController销毁");
}
...
- (void)loadSection0Datas {
    ...
    cellModel1.textPlaceholder = @"100-65535";
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKCommureApp", @"MKAdvParamsConfigController", @"cm_saveIcon.png") forState:UIControlStateNormal];
...
- (MKAdvParamsConfigModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKAdvParamsConfigModel alloc] init];
