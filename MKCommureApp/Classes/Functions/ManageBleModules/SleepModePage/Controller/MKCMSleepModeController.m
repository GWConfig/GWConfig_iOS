...
@interface MKCMSleepModeController ()

@property (nonatomic, strong)MKTextField *textField;

@end

@implementation MKCMSleepModeController

- (void)dealloc {
    NSLog(@"MKCMSleepModeController销毁");
}
...
- (void)readDataFromDevice {
    ...
    [MKCMMQTTInterface cm_readSleepModeParametersWithBleMacAddress:self.bleMac macAddress:[MKCMDeviceModeManager shared].macAddress topic:[MKCMDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKCommureApp", @"MKCMSleepModeController", @"cm_saveIcon.png") forState:UIControlStateNormal];
